...
func void DIA_Ehnim_MoleRatFett_was_Fett_habenwill ()
{
	...
	AI_Output			(self, other, "DIA_Ehnim_MoleRatFett_was_Fett_habenwill_12_01"); //That won't be cheap, pal. It's damn rare in this part of the country.
	AI_Output			(other, self, "DIA_Ehnim_MoleRatFett_was_Fett_habenwill_15_02"); //How much?
	AI_Output			(self, other, "DIA_Ehnim_MoleRatFett_was_Fett_habenwill_12_03"); //Hmm. 100 gold coins?
...
func void DIA_Ehnim_MoleRatFett_was_Fett_habenwill_zuviel_immernoch ()
{
	...
	AI_Output			(self, other, "DIA_Ehnim_MoleRatFett_was_immernoch_12_01"); //Then forget about it. Have a nice day.
	AI_StopProcessInfos (self);
};
