...
func void DIA_Addon_Cronos_Hallo_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Cronos_Hallo_04_01"); //It's YOU! I never thought I would see your face again.
...
func void DIA_Addon_Cronos_WasMachstdu_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Cronos_WasMachstdu_04_01"); //My task is to find out more about the guardians of the temple.
...
func void DIA_Addon_Cronos_Waechter_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Cronos_Waechter_04_01"); //I can't tell you much so far. Unfortunately, we have had to destroy them. Now they aren't dangerous.
