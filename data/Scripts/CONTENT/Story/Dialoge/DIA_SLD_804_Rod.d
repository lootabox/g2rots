...
{	
	...
	{
		AI_Output (self, other, "DIA_Rod_Hello_06_01"); //What do YOU want from me, weenie?
...
{	
	...
	AI_Output (self, other, "DIA_Rod_Wette_06_01"); //Really? Hmm... How much should I relieve you of?
...
func void DIA_Rod_Wette_Yes()
{
	...
	if (B_GiveInvItems (other,self, itmi_gold, 30))
	{
		...
		AI_Output (self, other, "DIA_Rod_Wette_Yes_06_03"); //All right, let's see then how strong you are...
		
		B_GiveInvItems (self, other, ItMw_2h_Rod, 1);
		
		if (other.attribute[ATR_STRENGTH] >= Condition_Zweihaender1)
		{
			...
			AI_Output (self, other, "DIA_Rod_Wette_Yes_06_05");//Looks like you got me there.
...
func void DIA_Rod_Wette_KeepIt()
{
	...
	AI_Output (self, other, "DIA_Rod_Wette_KeepIt_06_01"); //What was that?
