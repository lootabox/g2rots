...
{	
	...
	AI_Output (self, other, "DIA_Addon_Finn_Hacke_07_01"); //Go to Huno the smith. But even if you have a pick, that don't mean that you can get into the mine.
...
{	
	...
	AI_Output (self, other, "DIA_Addon_Finn_Esteban_07_01"); //He's the boss here... he's... all right, I think.
	AI_Output (self, other, "DIA_Addon_Finn_Esteban_07_02"); //He always lets the good boys into the mine. The ones who know something about mining, I mean.
};
...
FUNC VOID DIA_Addon_Finn_ein_Info()
{
	...
	ConcatText = ConcatStrings ("Gold-digging: ", IntToString (Hero_HackChance));
...
{
	AI_Output (self, other, "DIA_Addon_Finn_TellAll_07_00"); //When the attack took place, I was trying to get my pickaxe from Huno the smith.
...
func void DIA_Addon_Finn_Attentat_WannaTalk()
{
	...
	AI_Output (self, other, "DIA_Addon_Finn_WannaTalk_07_01"); //So? And what do you want from him.
...
func void DIA_Addon_Finn_Attentat_HaveInfos()
{
	...
	func void DIA_Addon_Finn_Attentat_NoNo()
	{
		...
		AI_Output (self, other, "DIA_Addon_Finn_NoNo_07_01"); //Good! I'll tell you what I know.
...
{
	AI_Output (other, self, "DIA_Addon_Finn_Again_Exit_15_00"); //Okay...
	Info_ClearChoices (DIA_Addon_Finn_Again);
};
