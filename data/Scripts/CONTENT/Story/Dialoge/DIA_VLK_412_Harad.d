...
{
	AI_Output (self, other, "DIA_Harad_Hallo_12_00"); //What do you want?
};
...
func void DIA_Harad_OrcRunning_Info ()
{
	...
	AI_Output (self, other, "DIA_Harad_OrcRunning_12_01"); //What?!
...
func void DIA_Harad_OrcRunning_TooHard()
{
	...
	AI_Output (self, other, "DIA_Harad_OrcRunning_TooHard_12_01"); //Hmm - looking at you, you might be right. You don't have much meat on your bones. But that can change.
	...
	AI_Output (self, other, "DIA_Harad_OrcRunning_TooHard_12_04"); //Hmm - Hakon, the weapons dealer in the marketplace, told me that he was attacked by bandits a few days ago.
...
func void DIA_Harad_Erzklingen_Info ()
{
	...
	else
	{
		...
		Info_AddChoice (DIA_Harad_Erzklingen,"I'll take the two-handed sword!",DIA_Harad_Erzklingen_2h);
		AFIP_SetChoiceItem(DIA_Harad_Erzklingen_2h, ItMw_2H_Blessed_01);
		Info_AddChoice (DIA_Harad_Erzklingen,"I'll take the one-handed sword!",DIA_Harad_Erzklingen_1h);
		AFIP_SetChoiceItem(DIA_Harad_Erzklingen_1h, ItMw_1H_Blessed_01);
	};
};
...
FUNC VOID DIA_Harad_Erzklingen_2h()
{
	...
	if (B_GiveInvItems (other,self,ItMi_Gold,Value_Blessed_2H_1))
	{
...
FUNC VOID DIA_Harad_Erzklingen_1h()
{
	...
	if (B_GiveInvItems (other,self,ItMi_Gold,Value_Blessed_1H_1))
	{
