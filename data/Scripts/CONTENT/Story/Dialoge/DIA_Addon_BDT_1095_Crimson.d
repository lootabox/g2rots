...
{
	AI_Output (self, other, "DIA_Addon_Crimson_FATAGN_LOS_10_00");//KHARDIMON FATAGN SHATAR FATAGN BELIAR.
};
...
FUNC VOID DIA_Addon_Crimson_Raven_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Crimson_Raven_10_02");//He mumbled and called some strange words. Over and over...
	B_Say_CrimsonBeliar();
	AI_Output (self, other, "DIA_Addon_Crimson_Raven_10_03");//And then a blazing light came out of the tomb and I heard the SCREAM.
	AI_Output (self, other, "DIA_Addon_Crimson_Raven_10_04");//Oh, ye gods, that voice. That was the sound of the end of the world!
