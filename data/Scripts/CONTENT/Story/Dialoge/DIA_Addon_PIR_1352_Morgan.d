...
func int DIA_Addon_Morgan_EXIT_Info ()
{
	if (GregIsBack == FALSE)
	{
		...
		{
			AI_Output	(self, other, "DIA_Addon_Morgan_Perm_07_02"); //Well, good night then.
			Morgan_Perm_Counter = 2;
		}
		else if (Morgan_Perm_Counter == 2)
		{
			AI_Output	(self, other, "DIA_Addon_Morgan_Perm_07_03"); //Heh, with the greatest pleasure.
			Morgan_Perm_Counter = 3;
		}
		else if (Morgan_Perm_Counter == 3)
		{
			AI_Output	(self, other, "DIA_Addon_Morgan_Perm_07_04"); //Awake me if anything happens.
...
func int DIA_Addon_Morgan_Anheuern_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Morgan_Anheuern_07_01"); //Have fun slaughtering monsters!
	};
};
...
{	
	...
	AI_Output (self ,other,"DIA_Addon_Morgan_Hello_07_01"); //Hmm? What do you want?
	AI_Output (self ,other,"DIA_Addon_Morgan_Hello_07_02"); //Is Alligator Jack back, then?
	AI_Output (self ,other,"DIA_Addon_Morgan_Hello_07_03"); //No? Then he'll certainly be here soon. Good night.
	AI_StopProcessInfos (self);
};
...
{	
	...
	if (GregIsBack == FALSE)
	{
		AI_Output (self ,other,"DIA_Addon_Morgan_Meat_07_01"); //(yawns) I need a sip to wake me up.
...
func void DIA_Addon_Morgan_FOUNDTHEM_NoRing()
{
	...
	AI_Output (self ,other,"DIA_Addon_Morgan_FOUNDTHEM_NoRing_07_01"); //What? Go back and look again. They must have had it.
...
func void DIA_Addon_Morgan_FOUNDTHEM_GiveRing()
{
	...
	AI_Output (self, other,"DIA_Addon_Morgan_FOUNDTHEM_GiveRing_07_01"); //(smiling) Yes, that's it. Good man!
...
{	
	...
	AI_Output (self ,other,"DIA_Addon_Morgan_Francis_07_01"); //I don't mind him as long as he leaves me alone!
	AI_Output (other,self ,"DIA_Addon_Morgan_Francis_15_02"); //Isn't he the boss around here?
	AI_Output (self ,other,"DIA_Addon_Morgan_Francis_07_03"); //(laughs) He THINKS he's the boss.
	AI_Output (self ,other,"DIA_Addon_Morgan_Francis_07_04"); //But at some point Greg will return, and then Francis gets to go back to sawing planks.
};
