...
func void DIA_Lord_Hagen_Frieden_Info ()
{
	...
	AI_Output (self, other, "DIA_Lord_Hagen_Frieden_04_01"); //Hmm, show me!
	B_UseFakeScroll ();
...
func void DIA_Lord_Hagen_Armee_Info ()
{
	...
	AI_Output (self, other, "DIA_Lord_Hagen_Armee_04_05"); //What army is that supposed to be?
...
func void DIA_Lord_Hagen_Auge_Info ()
{
	...
	AI_Output (self, other, "DIA_Lord_Hagen_Auge_04_01"); //It is a divine artifact. In the old prophecies it is mentioned in connection with dragons.
...
FUNC VOID DIA_Lord_Hagen_Knight_Yes()
{
	...
	AI_Output (self ,other,"DIA_Lord_Hagen_Knight_Yes_04_01"); //Then so shall it be!
	AI_Output (self ,other,"DIA_Lord_Hagen_Knight_Yes_04_02"); //Many men have taken this path and given their lives in the name of Innos.
	AI_Output (self ,other,"DIA_Lord_Hagen_Knight_Yes_04_03"); //Do you swear that your deeds will honor their deaths and proclaim the fame of Innos?
...
func void DIA_Lord_Hagen_BACKINTOWN_DelayChaseForEye ()
{
...
func void DIA_Lord_Hagen_BACKINTOWN_StartChaseForEye ()
{
	...
	B_LogEntry (TOPIC_INNOSEYE,"Lord Hagen's given me the message. With it the highest Fire Magician Pyrokar should hand me the Eye of Innos at the monastery.");
...
INSTANCE DIA_Lord_Hagen_Addon_Delay(C_INFO)
{
	npc			= PAL_200_Hagen;
	nr			= 997;
	condition	= DIA_Lord_Hagen_Addon_Delay_Condition;
	information	= DIA_Lord_Hagen_Addon_Delay_Info;
	permanent	= TRUE;
	description = "What about the letter for the Eye of Innos?";
};                       
FUNC INT DIA_Lord_Hagen_Addon_Delay_Condition()
{
	if (Kapitel == 2)
	&& (MIS_OLDWORLD == LOG_SUCCESS)
	&& (MIS_InnosEyeStolen == FALSE)
	{
		return TRUE;
	};
};
FUNC VOID DIA_Lord_Hagen_Addon_Delay_Info()
{	
	AI_Output (self ,other, "DIA_Lord_Hagen_CUSTOM_15_04"); //What about the letter for the Eye of Innos?
	if (RavenIsDead == TRUE) {
		DIA_Lord_Hagen_BACKINTOWN_StartChaseForEye();
	} else {
		DIA_Lord_Hagen_BACKINTOWN_DelayChaseForEye();
	};
};
...
{
	if (Kapitel == 3)
	|| ((Kapitel == 2) && (MIS_ReadyForAddon == TRUE))
	{
		return TRUE;
	};
};
...
func void DIA_Lord_Hagen_BACKINTOWN_Info ()
{
	...
	if (RavenIsDead == TRUE) {
		...
		DIA_Lord_Hagen_BACKINTOWN_DelayChaseForEye();
		B_LogEntry (TOPIC_INNOSEYE,"Lord Hagen will write a letter with which I can get the Eye of Innos from the monastery, but it seems like it will take a while. I should focus on other things in the meanwhile.");
	};
};
...
FUNC VOID DIA_Lord_Hagen_Cornelius_Info ()
{
	...
	AI_Output			(self ,other, "DIA_Lord_Hagen_Cornelius_04_03"); //That slimy little criminal!
...
FUNC VOID DIA_Lord_Hagen_AugeAmStart_Info ()
{
	...
	AI_Output (self ,other, "DIA_Lord_Hagen_Add_04_11"); //You bear the Eye!
	...
	if (Npc_HasItems (other,ItRi_OrcEliteRing))
		{
			...
			AI_Output			(self, other, "DIA_Lord_Hagen_ANTIPALADINE_04_07"); //Hmm. That is certainly disturbing.
...
{	
	...
	AI_Output (self ,other, "DIA_Lord_Hagen_Add_04_20"); //Damnit!
