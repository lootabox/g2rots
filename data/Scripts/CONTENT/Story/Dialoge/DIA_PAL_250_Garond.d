...
{		
	...
	AI_Output (self ,other,"DIA_Garond_zahlen_10_01"); //I am not used to haggling with mercenaries.
...
{		
	AI_Output (other,self ,"DIA_Garond_Pay_15_00"); //I want to buy Gorn's freedom.
...
func void DIA_Garond_BACKINKAP4_Info ()
{
	...
	{
	AI_Output (self, other, "DIA_Garond_BACKINKAP4_10_06"); //You mean yourself and your fellow dragon hunters, eh? You can help us, but there just aren't enough of you.
	}
	else
	{
...
func void DIA_Garond_AllDragonDead_Info ()
{
	...
	AI_Output (self, other, "DIA_Garond_AllDragonDead_10_01"); //(eyes wide) All of them? So evil has been vanquished forever?
