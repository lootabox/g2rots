...
FUNC VOID DIA_Addon_Edgor_Found_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Edgor_Found_06_01");//Really? You must be a brave guy.
	AI_Output (self, other, "DIA_Addon_Edgor_Found_06_02");//Then you've certainly earned your way into the camp. (yawns)
};
//---------------------------------------------------------------------
//	Info Teach
//---------------------------------------------------------------------
...
FUNC VOID DIA_Addon_Edgor_Teach_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Edgor_Teach_06_02");//But I know how to tear the stingers and wings from their dead bodies. Yeah, tear them out...
