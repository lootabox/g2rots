...
func void DIA_Maleth_Hallo_Info ()
{
	...
	AI_Output (self, other, "DIA_Maleth_Hallo_08_07"); //What do you want here?
};
...
func void DIA_Maleth_PROBLEME_schafe ()
{
	...
	AI_Output			(self, other, "DIA_Maleth_PROBLEME_schafe_08_01"); //As if that would interest you at all. You have other problems.
...
func void DIA_Maleth_PROBLEME_schafe_probleme ()
{
	AI_Output			(other, self, "DIA_Maleth_PROBLEME_schafe_probleme_15_00"); //My problems? What would you know about that?
		...
		{
			AI_Output			(self, other, "DIA_Maleth_PROBLEME_schafe_probleme_08_01"); //Do you belong to the city guard or not? Then do something about these black-robed bastards.
		};

		if ((hero.guild == GIL_SLD) || (hero.guild == GIL_DJG))
		{
			AI_Output			(self, other, "DIA_Maleth_PROBLEME_schafe_probleme_08_02"); //You filthy mercenaries only think of one thing: how do I get other people's money into my pocket.
		};
...
func void DIA_Maleth_PERM3_Info ()
{
	...
	AI_Output			(self, other, "DIA_Maleth_PERM3_08_01"); //Beat it.
	AI_StopProcessInfos (self);
};
