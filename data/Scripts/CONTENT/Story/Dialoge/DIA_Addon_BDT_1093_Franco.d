...
{	
	...
	AI_Output (self,other,"DIA_Addon_Franco_While_08_03");//You want gold? Sure, how much do you want? Fifty gold nuggets? A hundred? I'll give you as much gold as you can carry...
	AI_Output (self,other,"DIA_Addon_Franco_While_08_04");//Who do you think you are? Are you trying to make a fool out of me?
...
{	
	...
	AI_Output (self,other,"DIA_Addon_Franco_Fight_08_01"); //And what if I say no?
...
func void DIA_Addon_Franco_Fight_Nothing()
{
	...
	AI_Output (self,other,"DIA_Addon_Franco_Fight_Nothing_08_01"); //Exactly.
...
{	
	...
	AI_Output (self,other,"DIA_Addon_Franco_Pig_08_01");//You miserable little wretch, you want to mess with ME? Just you wait!
