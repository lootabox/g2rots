...
{
	AI_Output	(other,self ,"DIA_MiltenOW_Hello_YES_15_00");//Good to see you Milten. You're here again?
...
FUNC VOID DIA_MiltenOW_Versteck_Info()
{
	...
	AI_Output	(self ,other,"DIA_MiltenOW_Versteck_03_01"); //Former south gate, you mean to say. The dragon has reduced it to rubble.
...
{	
	...
	if  (Npc_GetTalentSkill (other, NPC_TALENT_MAGE) >= 2)
	{
		...
		{
			Info_AddChoice	(DIA_MiltenOW_Teach, B_BuildLearnString (NAME_SPL_WINDFIST, B_GetLearnCostTalent (other, NPC_TALENT_RUNES, SPL_WINDFIST)) ,TeachPlayerTalentRunes_SPL_Windfist);
		};
		...
		{
			Info_AddChoice	(DIA_MiltenOW_Teach, B_BuildLearnString (NAME_SPL_InstantFireball, B_GetLearnCostTalent (other, NPC_TALENT_RUNES, SPL_InstantFireball)) ,TeachPlayerTalentRunes_SPL_InstantFireball);
		};
		/* if (PLAYER_TALENT_RUNES [SPL_Icebolt] == FALSE) 
		{
			Info_AddChoice	(DIA_MiltenOW_Teach, B_BuildLearnString (NAME_SPL_Icebolt, B_GetLearnCostTalent (other, NPC_TALENT_RUNES, SPL_Icebolt)) ,TeachPlayerTalentRunes_SPL_Icebolt);
		}; */
	}
	else
	{
