...
func void DIA_Halvor_MESSAGE_Info ()
{
	...
	//B_UseFakeScroll 	();
	AI_Output (self, other, "DIA_Halvor_MESSAGE_06_02"); //Er... Ok, let's stay calm about this - er... listen. I have resold the goods I got from the bandits.
	AI_Output (self, other, "DIA_Halvor_MESSAGE_06_03"); //But there's no reason to take this straight to the militia, right? I'm sure we can come to an understanding, can't we?
...
FUNC VOID DIA_Halvor_Zeichen_Info()
{
	...
	AI_Output (self, other, "DIA_Halvor_Zeichen_06_01");//I'll make you an offer. If you have any silver plates or chalices - I'll take them for a good price.
