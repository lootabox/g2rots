...
{
	AI_Output	(other, self, "DIA_Addon_Baltram_Skip_15_00"); //You're doing business with pirates?
	AI_Output	(self, other, "DIA_Addon_Baltram_Skip_01_01"); //What? Who told you that?
...
{
	AI_Output			(other, self, "DIA_Addon_Baltram_Skip_was_15_00"); //What is it you're trading?
...
{
	AI_Output			(other, self, "DIA_Addon_Baltram_Skip_pirat_15_00"); //What do you know about the pirates?
	AI_Output			(self, other, "DIA_Addon_Baltram_Skip_pirat_01_01"); //They live in a remote part of the island of Khorinis.
...
func void DIA_Addon_Baltram_SkipsRum_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Baltram_SkipsRum_01_01"); //Damn expensive, that. Who does he think he is? Well, give it here then.
...
func void DIA_Baltram_HaveYourWarez_Info ()
{
	...
	&&  BaltramEnoughWine  == TRUE)
	{
		...
		AI_PrintScreen ("10 items given (Ham)", -1, 35, FONT_ScreenSmall, 2);
		Npc_RemoveInvItems (other, ItFo_Wine, 10);
		CreateInvItems (self, ItFo_Wine, 10);
		AI_PrintScreen ("10 items given (Wine)", -1, 38, FONT_ScreenSmall, 2);
