...
func void DIA_Garwig_THIEF_Info ()
{
	...
	{ 
		AI_Output (self, other, "DIA_Garwig_THIEF_06_00"); //Thief! You have disgraced not only yourself and me, but this entire monastery!
		AI_Output (self, other, "DIA_Garwig_THIEF_06_01"); //You shall atone for this sacrilege. And, above all - GIVE ME BACK THAT HAMMER!!
	}
	else
	{
		AI_Output (self, other, "DIA_Garwig_THIEF_06_02"); //The hammer has disappeared - how could that happen?
