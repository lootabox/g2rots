...
FUNC VOID DIA_Addon_Snaf_Abrechnung_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Snaf_Abrechnung_01_01"); //Hmm...
	...
	else if (Finn_Petzt == TRUE)
	{
		...
		AI_Output (self, other, "DIA_Addon_Snaf_Abrechnung_01_10"); //However, there is the danger that he will run to Esteban with it - but you know that yourself...
	};
	...
	if (Snaf_Rechnung == FALSE)
	{
		if (Snaf_Einmal == FALSE)
		{
			...
			AI_Output (self, other, "DIA_Addon_Snaf_Abschied_01_15"); //Hey! I didn't tell you anything you didn't already know, got it?!
