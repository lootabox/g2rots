...
func void DIA_Jora_GREET_Info ()
{
	...
	AI_Output (self, other, "DIA_Jora_GREET_08_03"); //Bah! You wouldn't be the first one to make off with my things today.
...
func void DIA_Jora_HolDeinGold_Info ()
{
	...
	AI_Output (self, other, "DIA_Jora_HolDeinGold_08_01"); //Oh? And why would you do that?
...
func void DIA_Jora_AlriksSchwert_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Jora_AlriksSchwert_08_08"); //I don't have it any more! The devil only knows where the thing is now.
	};
};
...
func void DIA_Jora_BUYAlriksSchwert_Info ()
{
	...
	if (B_GiveInvItems(other,self,itmi_gold,50))
	{
		...
		//else
		//{
			AI_Output (self, other, "DIA_Jora_BUYAlriksSchwert_08_04"); //Here you go - that was a good deal.
			B_GiveInvItems (self, other, ItMw_AlriksSword_Mis, 1);
		//};
	}
	else
