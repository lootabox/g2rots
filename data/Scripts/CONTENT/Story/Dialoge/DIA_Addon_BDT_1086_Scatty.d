...
FUNC VOID DIA_Addon_Scatty_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Scatty_Hi_01_03");//And the diggers are taking it easy. (to himself) Diggers who take it easy aren't good for business.
...
FUNC VOID DIA_Addon_Scatty_last_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Scatty_last_01_04");//...No, wait! The last time he was here was when he sent the slaves to mine the gold.
...
FUNC VOID DIA_Addon_Scatty_GruftAgain_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Scatty_GruftAgain_01_01");//Hm... you're pretty curious. You remind me of a fellow I once knew.
	...
	AI_Output (self, other, "DIA_Addon_Scatty_GruftAgain_01_04");//Well... (clears throat) my throat is really dry...
	AI_Output (other, self, "DIA_Addon_Scatty_GruftAgain_15_05");//Hey, Scatty, NOT NOW. This is important, so what did Raven do there?
	AI_Output (self, other, "DIA_Addon_Scatty_GruftAgain_01_06");//All right. He... he called... summoned something. He kept calling out words in a foreign language.
