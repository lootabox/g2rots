...
{
	AI_Output (self ,other,"DIA_Dyrian_Hello_13_00"); //What do you want?
};
// *************************************************************************
// 							Wurst verteilen
// *************************************************************************
...
{
	AI_Output (self ,other,"DIA_Dyrian_HelloAgain_13_00"); //Thanks, you saved me!
	AI_Output (self ,other,"DIA_Dyrian_HelloAgain_13_01"); //Oh - forgive me Master - I didn't mean to impose.
	AI_Output (self ,other,"DIA_Dyrian_HelloAgain_13_02"); //I thank you for being allowed to stay in the monastery. My life will be different from now on...
...
FUNC VOID DIA_Dyrian_Kneipe_Info()
{
	...
	Info_AddChoice (DIA_Dyrian_Kneipe,"Here, five gold pieces for you.",DIA_Dyrian_Kneipe_Gold);
...
{
	AI_Output	(other,self ,"DIA_Dyrian_Kneipe_Gold_15_00"); //Here, five gold pieces for you.
	AI_Output 	(self ,other,"DIA_Dyrian_Kneipe_Gold_13_01"); //Five coins? You're giving me five coins to make up for destroying my life?
