...
func void DIA_Torlof_Probe_Info ()
{
	...
	if (Npc_KnowsInfo (other, DIA_Lee_OtherSld))
	{
		...
		AI_Output (self, other, "DIA_Torlof_Probe_01_03"); //Fine. So here we go: There are two things you have to do before you can join us.
...
func void DIA_Torlof_BEMYCAPTAIN3_Info ()
{
	...
	AI_Output			(self, other, "DIA_Torlof_BEMYCAPTAIN3_01_01"); //Oh, yeah. You wanted to go to an island. Hmm. I'll make you a suggestion.
