...
{
	return C_StealItem(80, ItSc_ArmyOfDarkness);
};
...
{
	B_StealItem(80, ItSc_ArmyOfDarkness);
	Info_ClearChoices(DIA_Addon_Merdarion_NW_PICKPOCKET);
};
...
func void DIA_Addon_Merdarion_Aufgabe_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_Aufgabe_06_04"); //I can't remember ever having heard or read about that...
...
func void DIA_Addon_Merdarion_Teleportstein_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_Teleportstein_06_02"); //Hmm, but you could also... No. That would be too dangerous.
...
func void DIA_Addon_Merdarion_Teleportstein_key ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Merdarion_Teleportstein_key_06_01"); //Really? But I take no responsibility for it.
...
func void DIA_Addon_Merdarion_TeleportsteinSuccess_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Merdarion_TeleportsteinSuccess_06_03"); //Unbelievable. I'll have to look at this more closely later.
};
