...
{	
	...
	AI_Output (self ,other, "DIA_Addon_Samuel_Francis_14_05"); //Really? To do what?
	...
	AI_Output (self ,other, "DIA_Addon_Samuel_Francis_14_12"); //Ha! When the Captain comes back and finds some of his things missing, he'll have Francis' hide for it.
...
instance DIA_Addon_Samuel_Grog(C_INFO)
{
	...
	permanent	= TRUE;
	description = "I've come to get my ration of grog!";
};                       
FUNC INT DIA_Addon_Samuel_Grog_Condition()
{
	var int AFIP_ShowItem; AFIP_ShowItem = ItFo_Addon_Grog;
...
instance DIA_Addon_Samuel_Rum(C_INFO)
{
	...
	permanent	= TRUE;
	description = "Give me rum!";
};                       
FUNC INT DIA_Addon_Samuel_Rum_Condition()
{
	var int AFIP_ShowItem; AFIP_ShowItem = ItFo_Addon_rum;
...
func void DIA_Addon_Samuel_Stronger_Options()
{
	...
	{
		Info_AddChoice (DIA_Addon_Samuel_Stronger, "Give me a double. A double Hammer.", DIA_Addon_Samuel_Stronger_LousDoubleHammer);
		AFIP_SetChoiceItem(DIA_Addon_Samuel_Stronger_LousDoubleHammer, ItFo_Addon_SchlafHammer);
	};		
	if (Samuel_Knows_LousHammer == TRUE)
	{
		Info_AddChoice (DIA_Addon_Samuel_Stronger, "I want Lou's Hammer!", DIA_Addon_Samuel_Stronger_LousHammer);
		AFIP_SetChoiceItem(DIA_Addon_Samuel_Stronger_LousHammer, ItFo_Addon_LousHammer);
	};
	Info_AddChoice (DIA_Addon_Samuel_Stronger, "Give me some of your Hasty Herring.", DIA_Addon_Samuel_Stronger_SchnellerHering);
	AFIP_SetChoiceItem(DIA_Addon_Samuel_Stronger_SchnellerHering, ItFo_Addon_SchnellerHering);
};
...
{	
	...
	DIA_Addon_Samuel_Stronger_Options();
};
// ------------------------------------------------------------
...
{
	var int AFIP_ShowItem;
	AI_Output (other,self ,"DIA_Addon_Samuel_Stronger_LousDoubleHammer_15_00"); //Give me a double. A double Hammer.
	if (B_GiveInvItems (other,self,ItMi_Gold,Value_SchlafHammer))
	{
		...
		{
			AI_Output (self ,other,"DIa_Addon_Samuel_Stronger_LousDoubleHammer_14_02"); //Yes! Nothing like it to restore your spirits!
		};
