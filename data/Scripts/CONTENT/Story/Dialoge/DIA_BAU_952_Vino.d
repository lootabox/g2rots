	...
	if (hero.guild == GIL_NONE)
	{
		...
		if (!Npc_IsDead(Lobart))
		{
			...
			&& ( (Npc_KnowsInfo (other, DIA_Lobart_KLEIDUNG)) || (Npc_KnowsInfo (other, DIA_Lobart_WorkNOW)) )
			{
				...
				AI_Output (self, other, "DIA_Vino_SeekWork_05_07"); //Fetch me a bottle of wine and I'll tell Lobart that you were a real help to us. (laughs)
...
func void DIA_Vino_Obesessed_Info ()
{
	...
	{
		AI_Output			(self, other, "DIA_Vino_Obesessed_05_01"); //Damn, beat it! Otherwise, they'll kill me.
