...
func void DIA_Buster_Hello_ImNoDanger()
{
	...
	AI_Output (self ,other,"DIA_Buster_Hello_ImNoDanger_13_01"); //Yep, over the years you learn to spot these things, buddy.
...
func void DIA_Buster_Hello_SlewBeasts()
{
	...
	AI_Output (self ,other,"DIA_Buster_Hello_SlewBeasts_13_02"); //We're dealing with orcs here! Well, yeah, and with those scummy city guards. (laugh)
...
func void DIA_Buster_Hello_IfYouSaySo()
{
	...
	AI_Output (self ,other,"DIA_Buster_Hello_IfYouSaySo_13_01"); //Get a move on, you wimp!
...
func void DIA_Buster_Hello_SoWhat()
{
	...
	AI_Output (self ,other,"DIA_Buster_Hello_SoWhat_13_01"); //Hah! As if you knew what I'm talking about. You think you're mighty strong, don't you?
	AI_Output (self ,other,"DIA_Buster_Hello_SoWhat_13_02"); //Maybe it's about time that somebody taught you a lesson!
...
func void DIA_Buster_Hello_RealOrcs()
{
	...
	AI_Output (self ,other,"DIA_Buster_Hello_RealOrcs_13_01"); //I'm talking about... Just a moment! Are you trying to pull my leg?
	AI_Output (other,self ,"DIA_Buster_Hello_RealOrcs_15_02"); //(smiling) Far be that from me.
	AI_Output (self ,other,"DIA_Buster_Hello_RealOrcs_13_03"); //You worm! You're really asking for it, huh?
