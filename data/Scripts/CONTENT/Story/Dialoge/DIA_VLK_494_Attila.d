...
FUNC VOID DIA_Attila_Hallo_Wer()
{
	...
	AI_Output (self, other, "DIA_Attila_Hallo_Wer_09_02"); //You should know that best, stranger. (laughs)
...
FUNC VOID DIA_Attila_Hallo_Theater()
{
	...
	Info_ClearChoices 	(DIA_Attila_Hallo);
	Info_AddChoice		(DIA_Attila_Hallo,"I'm going to leave now...",DIA_Attila_Hallo_Ende);
	Info_AddChoice		(DIA_Attila_Hallo,"Who pays you for this?",DIA_Attila_Hallo_Auftrag);
...
func void DIA_Attila_Willkommen_Info ()
{
	...
	AI_Output (self, other, "DIA_Attila_Willkommen_09_05"); //I have a gift for you. Everything else is up to you, stranger. (laughs)
