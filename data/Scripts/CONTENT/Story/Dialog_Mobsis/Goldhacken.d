...
FUNC VOID PC_Goldhacken_Addon_Chance_Info()
{
	...
	{
		ConcatText = ConcatStrings ("An absolute beginner (", IntToString (Hero_HackChance));
	}
	else if (Hero_HackChance < 40) 
	{
		ConcatText = ConcatStrings ("A quite passable scraper (" , IntToString (Hero_HackChance));
	}
	else if (Hero_HackChance < 55) 
	{
		ConcatText = ConcatStrings ("An experienced gold scraper (", IntToString (Hero_HackChance));
	}
	else if (Hero_HackChance < 75) 
	{
		ConcatText = ConcatStrings ("A genuine digger (", IntToString (Hero_HackChance));
	}
	else if (Hero_HackChance < 90) 
	{
		ConcatText = ConcatStrings ("A damned good digger (", IntToString (Hero_HackChance));
	}
	else if (Hero_HackChance < 98) 
	{
		ConcatText = ConcatStrings ("A master digger (", IntToString (Hero_HackChance));
	}
	else
	{
		ConcatText = ConcatStrings ("A guru among diggers (", IntToString (Hero_HackChance));
	};
