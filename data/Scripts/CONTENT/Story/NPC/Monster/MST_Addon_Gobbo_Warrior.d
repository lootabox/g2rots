...
INSTANCE Gobbo_Warrior (Mst_Default_Gobbo_Warrior)
{
	...
	Npc_SetToFightMode (self, ItMw_1h_Sld_Sword); //Waffe ist nur Optik - Schaden wird NUR über STR bestimmt (Gobbo ist als Monster im Fistmode)
...
INSTANCE Gobbo_Warrior_Visir (Mst_Default_Gobbo_Warrior)
{
	...
	Npc_SetToFightMode (self, ItMw_1h_Sld_Axe); //Waffe ist nur Optik - Schaden wird NUR über STR bestimmt (Gobbo ist als Monster im Fistmode)
	Mdl_SetModelScale(self, 1.15, 1.15, 1.15);
};
