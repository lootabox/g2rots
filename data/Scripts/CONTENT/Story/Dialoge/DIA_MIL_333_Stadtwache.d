	...
	else // ------ normales Reinkommen ------
	{
		...
		|| (Hlp_IsItem(itm, ItAr_Bau_M) == TRUE)
		{
			...
			if (Npc_KnowsInfo (other, DIA_Mil_310_Stadtwache_MilizWerden))
			{
				...
				AI_Output (self, other,"DIA_Mil_333_Stadtwache_FirstWarn_06_14"); //(laughs) Oh man! They're always sending us the cream of the crop...
			};
		}
 	 	// ------ alle anderen Rüstungen ------
		else 
		{
			AI_Output (other, self,"DIA_Mil_333_Stadtwache_FirstWarn_15_15"); //What?
...
func void DIA_Mil_333_Stadtwache_Bribe_Info()
{
	...
	{
		AI_Output (self, other,"DIA_Mil_333_Stadtwache_Bribe_06_01"); //100 pieces of gold sounds fine. In you go, then.
