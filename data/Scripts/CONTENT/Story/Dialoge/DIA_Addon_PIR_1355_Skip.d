...
{	
	...
	AI_Output (self ,other,"DIA_Addon_Skip_Hello_08_04"); //I see I made a lasting impression.
...
func void DIA_Addon_SkipADW_BaltramPaket_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_SkipADW_BaltramPaket_08_01"); //(grins) That guy must be really keen on our rum if he sends his goods after us all the way HERE.
...
func void DIA_Addon_Skip_ADW_GregGetroffen_Info ()
{
	...
	AI_Output (self, other, "DIA_Addon_Skip_ADW_GregGetroffen_08_03"); //I suppose I should go back to Khorinis and wait for him there...
...
{	
	...
	AI_Output (self ,other,"DIA_Addon_Skip_AngusnHank_08_09"); //We're talking at least 20 bottles!
...
func void DIA_Addon_Skip_Grog_geben ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Skip_Grog_geben_08_05"); //Hmm. Let's see. I've got this ring here.
