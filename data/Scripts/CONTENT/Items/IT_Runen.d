...
//	TEXT	[1]			=	NAME_Manakosten;
	...
	TEXT	[4]			=	ConcatStrings(NAME_PalRepelEvil_Info, NAME_MustBeEvil);
...
INSTANCE ItRu_FireBolt (C_Item)
{
	...
	TEXT	[3]			=	ConcatStrings(NAME_Dot_Fire, NAME_Sec_Duration);
	COUNT	[3]			=	DOT_BURN_VFX_DURATION_S;
...
INSTANCE ItRu_Zap (C_Item)
{
	...
	TEXT	[3]			=	NAME_Zap_Damage;
	COUNT	[3]			=	SPL_SHORTZAPPED_DAMAGE_PER_SEC * SPL_TIME_SHORTZAPPED;
...
INSTANCE ItRu_LightningFlash (C_Item)
{
	...
	TEXT	[3]			=	NAME_Zap_Damage;
	COUNT	[3]			=	SPL_ZAPPED_DAMAGE_PER_SEC * SPL_TIME_ZAPPED;
