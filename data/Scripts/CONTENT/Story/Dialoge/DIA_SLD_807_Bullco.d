...
func void DIA_Bullco_WontLeave_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Bullco_WontLeave_06_02"); //Yeah, yeah, go tell it to someone who cares.
		Bullco_scharf = FALSE;
		AI_StopProcessInfos (self);
	};
};
...
func void DIA_Bullco_PepesSchafe_Info ()
{
	...
	AI_Output (other, self, "DIA_Bullco_PepesSchafe_15_06"); //If you keep getting on my nerves, I'll see to it that you are made to pay for the sheep.
	AI_Output (other, self, "DIA_Bullco_PepesSchafe_15_07"); //So if you're at all interested in your pay, leave me alone from now on!
	AI_Output (self, other, "DIA_Bullco_PepesSchafe_06_08"); //You, you...
	AI_Output (other, self, "DIA_Bullco_PepesSchafe_15_09"); //Yes?
