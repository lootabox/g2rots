...
{		
	...
	&& (Logan_Inside == FALSE)
	{
		AI_Output (self,other,"DIA_Addon_Logan_EXIT_10_01");//Yeah, you just run away. I'll stay here and stop everything that gets too close.
	};
...
FUNC VOID DIA_Addon_Logan_How2_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Logan_How2_10_05"); //Esteban thinks that Snaf is involved. I'm supposed to keep an eye on him...
...
FUNC VOID DIA_Addon_Logan_Why_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Logan_Why_10_01"); //Franco will let you rot here if you don't do it.
	...
	AI_Output (self, other, "DIA_Addon_Logan_Why_10_06"); //And the next one who gets in is me... ... it had better be...
...
FUNC VOID DIA_Addon_Logan_Lager_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Logan_Lager_10_01");//The question is what ISN'T in the camp. There are no swampsharks, no swamp holes... no SWAMP at all.
...
FUNC VOID DIA_Addon_Logan_MIS_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Logan_MIS_10_01");//You've figured out how to get ahead here. I'm pleased. Psst... do you hear that? Yeeaah, I hear them.
