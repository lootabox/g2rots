...
func void DIA_Mil_310_Stadtwache_FirstWarn_Info()
{
	...
	else // ------ normales Reinkommen ------
	{
		...
		{
			AI_Output (other, self,"DIA_Mil_310_Stadtwache_FirstWarn_15_18"); //What?
...
func void DIA_Mil_310_Stadtwache_Bribe_Info()
{
	...
	{
		AI_Output (self, other,"DIA_Mil_310_Stadtwache_Bribe_07_01"); //100 gold pieces sounds good. In you go then.
...
FUNC VOID DIA_Mil_310_Stadtwache_ZumSchmied_Info()
{
	...
	{
		AI_Output (self, other,"DIA_Mil_310_Stadtwache_ZumSchmied_07_01"); //Oh? And why didn't you say so right away?
	...
	AI_Output (self, other,"DIA_Mil_310_Stadtwache_ZumSchmied_07_05"); //And if you see Lobart, you can tell him he should feed his sheep well, we're coming back to him shortly! (laughs)
...
FUNC VOID DIA_Addon_Mil_310_Stadtwache_Constantino_Info()
{
	...
	{
		AI_Output (self, other,"DIA_Addon_Mil_310_Stadtwache_Constantino_07_01"); //Really? Then you won't mind showing me what you've brought.
		...
		{
			AI_Output (self, other,"DIA_Addon_Mil_310_Stadtwache_Constantino_07_02"); //Hmm... Looks good. All right. In you go. But don't cause any trouble, understood?
...
func void DIA_Mil_310_Stadtwache_Paladine_NoSomeone() //+2 --> weiter
{
	...
	AI_Output (self, other,"DIA_Mil_310_Stadtwache_Paladine_NoSomeone_07_01"); //WHO sent you?
