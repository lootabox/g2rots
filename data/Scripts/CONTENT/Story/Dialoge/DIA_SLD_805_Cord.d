...
func void DIA_Addon_Cord_YouAreRanger_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Cord_YouAreRanger_14_04"); //Look's like I've got to deal with you now, doesn't it?
...
{
	AI_Output			(self, other, "DIA_Addon_Cord_YouAreRanger_WARN_14_00"); //And woe betide you if I hear that you can't keep your trap shut. And I'm only saying this once, understand?
};
func void 	B_DIA_Addon_Cord_YouAreRanger_FRESSE ()
{
	AI_Output			(self, other, "DIA_Addon_Cord_YouAreRanger_FRESSE_14_00"); //That's it. Now you've gone too far. I'll sweep the yard with you.
	AI_StopProcessInfos (self);
...
func void DIA_Addon_Cord_YouAreRanger_waffe ()
{
	...
	if (Cord_SC_Dreist == FALSE)
	{
		AI_Output (self, other, "DIA_Addon_Cord_Add_14_03"); //Do you, now?
		AI_Output (self, other, "DIA_Addon_Cord_Add_14_02"); //Just try and get it!
		Cord_SC_Dreist = TRUE;
	}
	else
	{
...
func void DIA_Addon_Cord_RangerHelp2GetSLD_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Cord_RangerHelp2GetSLD_14_01"); //Let me think. Hmm. You'll have to get past Torlof if you want to make any progress here.
