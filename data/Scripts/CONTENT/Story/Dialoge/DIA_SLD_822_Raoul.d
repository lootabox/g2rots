...
{	
	...
	&& (!C_NpcIsDown(Sentenza))
	{
		...
		AI_Output (self ,other,"DIA_Raoul_NoSentenza_01_03"); //One moment, he'll be right here!
...
{	
	...
	{
		AI_Output (self ,other,"DIA_Raoul_Hello_01_00"); //What do you want?
	}
	else
	{
		AI_Output (self ,other,"DIA_Raoul_Hello_01_01"); //What do you want this time?
	};
};
...
{
	AI_Output			(self, other, "DIA_Raoul_TROLL_01_00"); //Will you look at that!
...
func void DIA_Raoul_TROLL_rechnung ()
{
	...
	AI_Output			(self, other, "DIA_Raoul_TROLL_rechnung_01_05"); //What's that supposed to mean, 'so what'?
...
func void B_Raoul_Blame ()
{
	...
	AI_Output			(self, other, "DIA_Raoul_TROLL_rechnung_B_Raoul_Blame_01_05"); //Hmm. Shall we say, I'll pay you a ton of money if you bring me the hide of a black troll. How's that sound?
...
func void DIA_Raoul_Ship_Info ()
{
	...
	AI_Output			(self, other, "DIA_Raoul_Ship_01_03"); //You are completely crazy. No, thanks. Not for me.
