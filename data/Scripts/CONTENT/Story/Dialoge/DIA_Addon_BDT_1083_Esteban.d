...
FUNC VOID DIA_Addon_Esteban_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Esteban_Hi_07_03");//Just to make it clear, if you try the same shit with me, (laughs) I'll kill you.
};
//--------------------------------------------------------------------
//	Info Mine
//--------------------------------------------------------------------
...
FUNC VOID DIA_Addon_Esteban_Rot_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Esteban_Rot_07_03");//How much do you know about mining gold, hm?
	...
	AI_Output (self, other, "DIA_Addon_Esteban_Rot_07_06");//If I give you a red stone, it won't be because you're such a great digger.
