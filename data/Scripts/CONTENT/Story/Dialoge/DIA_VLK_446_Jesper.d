...
FUNC VOID DIA_Jesper_Hallo_Umgelegt()
{
	...
	AI_Output (self, other,"DIA_Jesper_Hallo_Umgelegt_09_01");//YOU killed Attila?! ... So what, he was a lousy dog anyway.
...
FUNC VOID DIA_Jesper_Hallo_Was()
{
	...
	AI_Output (self, other,"DIA_Jesper_Hallo_Was_09_01");//... I live here. One more stupid question and I'll cut a design in your hide.
};
FUNC VOID DIA_Jesper_Hallo_Anfuehrer()
{
	AI_Output (other, self,"DIA_Jesper_Hallo_Anfuehrer_15_00");//Take me to your leader.
	AI_Output (self, other,"DIA_Jesper_Hallo_Anfuehrer_09_01");//Ha! My leader? I'm sure Cassia will want to talk to you.
