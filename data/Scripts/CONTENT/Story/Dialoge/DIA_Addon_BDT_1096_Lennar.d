...
FUNC VOID DIA_Addon_Lennar_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Lennar_Hi_01_03");//Right, but the bandits are also only here to dig. So...
};
...
FUNC VOID DIA_Addon_Lennar_Attentat_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Lennar_ATTENTAT_01_00"); //Yes?
	AI_Output (other, self, "DIA_Addon_Lennar_ATTENTAT_15_01"); //Do you have any idea who was behind it?
	AI_Output (self, other, "DIA_Addon_Lennar_ATTENTAT_01_02"); //Sure!
	AI_Output (self, other, "DIA_Addon_Lennar_ATTENTAT_01_03"); //Let me tell you: I bet that Emilio is behind this!
	AI_Output (self, other, "DIA_Addon_Lennar_ATTENTAT_01_04"); //He always ran to the mine like a crazy man. He dug as much as he could.
	AI_Output (self, other, "DIA_Addon_Lennar_ATTENTAT_01_05"); //But since the attack, he's been sitting on his bench, not budging an inch.
	AI_Output (self, other, "DIA_Addon_Lennar_ATTENTAT_01_06"); //It's obvious! To get into the mine, he has to have a red stone from Esteban.
	AI_Output (self, other, "DIA_Addon_Lennar_ATTENTAT_01_07"); //I bet he doesn't dare look him in the eye.
