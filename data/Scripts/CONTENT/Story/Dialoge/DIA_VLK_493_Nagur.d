...
///////////////////////////////////////////////////////////////////////
	...
	func void B_Nagur_Abfertigen()
	{
		...
		AI_Output (self ,other,"DIA_Nagur_Add_08_03"); //You're about to stick your nose into things that are none of your business!
...
FUNC VOID DIA_Nagur_Job_Info()
{
	...
	{
		AI_Output (self, other, "DIA_Nagur_Job_08_01");//Well, well, so you're looking for a special job. Okay, but we play by my rules, understood?
...
FUNC VOID DIA_Nagur_Auftrag_Wann()
{
	...
	AI_Output (self, other, "DIA_Nagur_Auftrag_Wann_08_01");//You can go right away. He should know by now that his messenger won't be showing up anymore. (laughs)
};
