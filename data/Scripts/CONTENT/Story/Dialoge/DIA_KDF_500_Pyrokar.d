...
func void DIA_Pyrokar_WELCOME_Info ()
{
	...
	AI_Output (self, other, "DIA_Pyrokar_WELCOME_11_01"); //You know that everyone within the Community of the Fire must carry out his duty according to the will of Innos.
};
///////////////////////////////////////////////////////////////////////
//	Info Hagen
///////////////////////////////////////////////////////////////////////
...
{
	AI_Output (self, other, "DIA_Pyrokar_GOAWAY_11_00"); //Obedience is a virtue you are still going to learn. One way or another.
...
func void DIA_Pyrokar_FIRE_Info ()
{
	...
	AI_Output (self, other, "DIA_Pyrokar_FIRE_11_01"); //So you know about... you want to pass the Test of Fire?
	AI_Output (other, self, "DIA_Pyrokar_FIRE_15_02"); //Yes, I refer to the Law of the Fire, which says...
	AI_Output (self, other, "DIA_Pyrokar_FIRE_11_03"); //(interrupts) We know the Law of the Fire. We have also seen many novices die during the test. You ought to reconsider this decision.
	AI_Output (other, self, "DIA_Pyrokar_FIRE_15_04"); //Yes, I have. I want the test - and I am going to pass it.
	AI_Output (self, other, "DIA_Pyrokar_FIRE_11_05"); //If you absolutely insist, then the High Council will put you to the test.
...
func void DIA_Pyrokar_TEST_Info ()
{
	...
	AI_Output (self, other, "DIA_Pyrokar_TEST_11_02"); //The Test of Magic. You probably know that only ONE of the novices can pass the test.
	...
	AI_Output (self, other, "DIA_Pyrokar_TEST_11_05"); //But enough of that! Hear the words of the test: 'Follow the signs of Innos and bring us what the believer finds behind the path.'
...
func void DIA_Pyrokar_SUCCESS_Info ()
{
	...
	AI_Output (self, other, "DIA_Pyrokar_SUCCESS_11_01"); //(eyes wide) You... did it?! You followed the signs and discovered the hidden portal...
...
func void DIA_Pyrokar_MAGICAN_Info ()
{
	...
	AI_Output (self, other, "DIA_Pyrokar_MAGICAN_11_02"); //Just as certain as we are that you will continue to give your best to become a WORTHY servant of Innos.
...
func void DIA_Pyrokar_OATH_Info ()
{
	...
	AI_Output (self, other, "DIA_Pyrokar_OATH_11_02"); //Do you swear, before Lord Innos the Almighty, his servants and the Holy Flame...
	...
	if (!Npc_IsDead(Gorax)) {
		CreateInvItems(Gorax,ItMw_MageStaff_Normal_2H_02,1);
	};
	if(!Npc_IsDead(Ulf))
	{
...
FUNC VOID DIA_Pyrokar_Wunsch_Nothing ()
{
	...
	AI_Output (self ,other,"DIA_Pyrokar_Wunsch_Nothing_11_01"); //So be it. The new magician foregoes his act.
...
func void DIA_Pyrokar_SPELLS_Info ()
{
	...
	{
		Info_AddChoice	(DIA_Pyrokar_SPELLS, B_BuildLearnString (NAME_SPL_ArmyOfDarkness, B_GetLearnCostTalent (other, NPC_TALENT_RUNES, SPL_ArmyOfDarkness)) ,TeachPlayerTalentRunes_SPL_ArmyOfDarkness);
		abletolearn = (abletolearn +1);
	};
	if (abletolearn < 1)
	{
...
{
	if (Kapitel >= 2) && (MIS_ReadyForAddon == TRUE)
	{
		return TRUE;
	};
};
...
instance DIA_Pyrokar_BACKFROMADW		(C_INFO)
{
	npc		 = 	KDF_500_Pyrokar;
	nr		 = 	30;
	condition	 = 	DIA_Pyrokar_BACKFROMADW_Condition;
	information	 = 	DIA_Pyrokar_BACKFROMADW_Info;

	description	 = 	"I was attacked by men in black robes.";
};

func int DIA_Pyrokar_BACKFROMADW_Condition ()
{
	if (Kapitel >= 3)	
	{
		return TRUE;
...
func void DIA_Pyrokar_BACKFROMADW_Info ()
{
...
func void DIA_Pyrokar_BUCHZURUECK_Info ()
{
	...
	AI_Output			(self, other, "DIA_Pyrokar_BUCHZURUECK_11_03"); //But this is incredible. Do you have even the slightest notion what it is that you just gave me?
	AI_Output			(other, self, "DIA_Pyrokar_BUCHZURUECK_15_04"); //Ehm... no.
	AI_Output			(self, other, "DIA_Pyrokar_BUCHZURUECK_11_05"); //This is an ancient, long-lost tome from days gone by.
...
func void DIA_Pyrokar_WASISTIRDORATH_Info ()
{
	...
	AI_Output			(other, self, "DIA_Pyrokar_WASISTIRDORATH_15_07"); //Disappeared. An entire temple. Yeah, right.
...
func void DIA_Pyrokar_GEHEIMEBIBLIOTHEK_Info ()
{
	...
	AI_Output			(other, self, "DIA_Pyrokar_GEHEIMEBIBLIOTHEK_15_04"); //I see. You have no idea. Hmm.
...
func void DIA_Pyrokar_MACHDTFREI_Info ()
{
	...
	AI_Output			(self, other, "DIA_Pyrokar_MACHDTFREI_11_01"); //Hmm. There is indeed one thing you could do for me. Your good rapport with Xardas could help you with that.
...
func void DIA_Pyrokar_PotionofDeath_Info ()
{
	...
	AI_Output		(self, other, "DIA_Pyrokar_PotionofDeath_11_01"); //The Tears of Innos are nothing but an old child's tale. It tells of how the battle between Innos and Beliar started at the beginning of time.
...
FUNC VOID DIA_Pyrokar_PotionofDeath_Potion ()
{
	...
	AI_Output (other,self ,"DIA_Pyrokar_PotionofDeath_Potion_15_04"); //Hardly.
