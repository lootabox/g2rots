...
{	
	...
	AI_Output (self, other, "DIA_Addon_TAL_BDT_13_Tal_13_01");//There's lots of old stuff here. Raven's ordered us to gather up everything.
...
{	
	...
	{
		AI_Output (self, other, "DIA_Addon_TAL_BDT_13_News_13_03");//But what can they do? Attack the camp? (laughs)
		BDT_13_einmal = TRUE;
	};
};
