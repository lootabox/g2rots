...
{	
	AI_Output (self,other,"DIA_Addon_Greg_Hello_01_00"); //Hey, you. What are you doing in my hut?
	AI_Output (other,self,"DIA_Addon_Greg_Hello_15_01"); //I...
	AI_Output (self,other,"DIA_Addon_Greg_Hello_01_02"); //I've just been gone for a couple of days, and everyone thinks they can do what they damn well please.
	//AI_Output (other,self,"DIA_Addon_Greg_ImNew_15_00"); //Ich bin der Neue.
	//AI_Output (self,other,"DIA_Addon_Greg_ImNew_01_01"); //So so, du bist der Neue.
	...
	if (!Npc_IsDead (Francis))
	{
		...
		AI_Output (self,other,"DIA_Addon_Greg_ImNew_01_05"); //So this is all you've accomplished, Francis?
		
		if (C_BodyStateContains (Francis, BS_SIT))
		{
			AI_Output (self,other,"DIA_Addon_Greg_ImNew_01_06"); //Get off of my bench at once!
		};
