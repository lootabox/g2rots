...
func void DIA_Vatras_DI_HEAL_Info ()
{
	...
	{
		AI_Output			(self, other, "DIA_Vatras_DI_HEAL_05_01"); //Adanos bless this body. It is destined to restore the balance of the world.
...
func void DIA_Vatras_DI_PEDROTOT_Info ()
{
	...
	else
	{
		...
		if (Npc_IsDead(Pedro_DI)) 
		{
			...
			AI_Output			(self, other, "DIA_Vatras_DI_PEDROTOT_05_07"); //Oh. That is very regrettable. I shall pray for his poor soul.
		}
		else
		{
			AI_StopProcessInfos (self);
...
func void DIA_Vatras_DI_UndeadDragonDead_Info ()
{
	...
	if (DIA_Vatras_DI_UndeadDragonDead_OneTime == FALSE)
	{
		...
		AI_Output (self, other, "DIA_Vatras_Add_05_17"); //But he did - of that you can be certain.
