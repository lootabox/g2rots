...
func void DIA_Addon_Erol_Hallo_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Erol_Hallo_10_01"); //What's the matter? Just look at that mess under the bridge over there.
	AI_Output	(self, other, "DIA_Addon_Erol_Hallo_10_02"); //I haven't seen anything like it in my entire life. Those swine should be exterminated, I tell you.
};
...
{
	AI_Output	(other, self, "DIA_Addon_Erol_SLD_15_00"); //This here is YOUR hut?
