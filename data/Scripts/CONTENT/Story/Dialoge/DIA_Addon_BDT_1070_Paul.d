...
FUNC VOID DIA_Addon_Paul_HunoArbeit_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Paul_HunoArbeit_03_01"); //I know nothing - honest! I have to go now!
...
{
	AI_Output (other, self, "DIA_Addon_Paul_MaulPaul_15_00"); //Tell me what you know now or I'll slam you into the wall, Paul!
	AI_Output (self, other, "DIA_Addon_Paul_MaulPaul_03_01"); //You can't rough me up just because you work for the boss.
	AI_Output (other, self, "DIA_Addon_Paul_MaulPaul_15_02"); //I can!
	AI_Output (self, other, "DIA_Addon_Paul_MaulPaul_03_03"); //Cut the crap!
	AI_Output (other, self, "DIA_Addon_Paul_MaulPaul_15_04"); //Paul...
	AI_Output (self, other, "DIA_Addon_Paul_MaulPaul_03_05"); //All I know is that Huno has a bone to pick with Esteban.
	AI_Output (self, other, "DIA_Addon_Paul_MaulPaul_03_06"); //He's constantly going on at me about that Esteban. That he screwed up business for him and so on...
