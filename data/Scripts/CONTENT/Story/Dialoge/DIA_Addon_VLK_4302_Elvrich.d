...
func void DIA_Addon_Elvrich_LuciaLetter_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Elvrich_LuciaLetter_04_01"); //What? Give it here!
	AI_PrintScreen (PRINT_ItemGegeben, -1, YPOS_ItemGiven, FONT_ScreenSmall, 2);
	B_UseFakeScroll ();
	AI_Output	(self, other, "DIA_Addon_Elvrich_LuciaLetter_04_02"); //NO! I don't believe this. No. I just can't believe it.
	AI_Output	(self, other, "DIA_Addon_Elvrich_LuciaLetter_04_03"); //She can't just leave me behind like this.
	AI_Output	(self, other, "DIA_Addon_Elvrich_LuciaLetter_04_04"); //Take this letter back. I don't want it. I firmly believe that she's going to come back to me some day.
