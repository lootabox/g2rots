...
func void DIA_Sekob_Defeated_Info ()
{
	...
	AI_Output (self, other, "DIA_Sekob_Defeated_01_03"); //But sir, I don't have anything. I'm just a poor wretch, and half-starved.
...
func void B_Sekob_Kassieren()
{
	...
	AI_Output (self, other, "DIA_Sekob_Kassieren_01_01"); //No, please, here take the gold. I'll even add a bonus if you let me live.
	B_GiveInvItems (self, other, ItMi_Gold, 60);
	AI_Output (other, self, "DIA_Sekob_Kassieren_15_02"); //See, that wasn't so hard.
	AI_Output (self ,other, "DIA_Sekob_Kassieren_01_03"); //I'm ruined.
