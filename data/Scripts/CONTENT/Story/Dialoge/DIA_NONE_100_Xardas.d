...
{	
	...
	AI_Output (self, other,"DIA_Xardas_FirstEXIT_14_02"); //Since I have gone into exile, the Circle of Fire has taken me for dead - and that's a good thing.
...
FUNC VOID DIA_Xardas_Hello_Info()
{
	...
	AI_Output (self ,other,"DIA_Xardas_Hello_14_15"); //We do not have much time left.
};
///////////////////////////////////////////////////////////////////////
//	Info AWAY
///////////////////////////////////////////////////////////////////////
...
func void DIA_Xardas_TODO_Info ()
{
	...
	AI_Output (self, other, "DIA_Xardas_TODO_14_01"); //This time we cannot handle it by ourselves. Only the power of Innos will help us against these dragons.
...
func void DIA_Addon_Xardas_AddonSuccess_Info ()
{
	...
	if (C_SCHasBeliarsWeapon())
	{
		...
		AI_Output (self, other, "DIA_Addon_Xardas_AddonSuccess_14_08"); //How very interesting.
	...
	else
	{
		...
		AI_Output (self, other, "DIA_Addon_Xardas_AddonSuccess_14_13"); //Are you out of your mind? Do you have any idea what you gave away there?
...
func void DIA_Xardas_PALADIN_Info ()
{
	...
	AI_Output (other, self, "DIA_Xardas_PALADIN_15_04"); //Let's assume you're right, and I'm destined to bear the Eye of Innos. How would the paladins know that is true?
...
func void DIA_Xardas_BACKFROMOW_Info () // Pre-Addon
{
	...
	Info_AddChoice	(DIA_Xardas_BACKFROMOW, "I've finally got the proof for Lord Hagen.", DIA_Xardas_BACKFROMOW_Beweis );
};

func void DIA_Xardas_BACKFROMOW_Beweis () // Pre-Addon
{
	...
	Info_ClearChoices	(DIA_Xardas_BACKFROMOW);
	Info_AddChoice	(DIA_Xardas_BACKFROMOW, "(continue)", DIA_Xardas_BACKFROMOW_Start_Addon );
	
	// B_GivePlayerXP (XP_Ambient);
};
func void DIA_Xardas_BACKFROMOW_Start_Addon () // Pre-Addon
{
...
{
	if (Kapitel == 3)	
	&& (Npc_KnowsInfo(other, DIA_Addon_Xardas_AddonSuccess))
	//	&& (Npc_KnowsInfo(other, DIA_Xardas_BACKFROMOW))
	{
		return TRUE;
	};
...
func void DIA_Xardas_DMTSINDDA_Info () // Post-Addon
{
...
func void DIA_Xardas_DMTSINDDA_DMT () // Post-Addon
{
...
func void DIA_Xardas_DMTSINDDA_DMT_WhatToDo () // Post-Addon
{
...
func void DIA_Xardas_WARUMNICHTJETZT_Info ()
{
	...
	AI_Output			(self, other, "DIA_Xardas_WARUMNICHTJETZT_14_02"); //Do not talk to me in that tone. If it weren't for ME, your wretched body would still be rotting in that temple.
...
func void DIA_Xardas_BEREIT_Info ()
{
	...
	AI_Output			(self, other, "DIA_Xardas_BEREIT_14_01"); //We must not lose any more time, then. I shall be on my way to the Circle of the Sun immediately. Fulfill your tasks. I'll meet you there.
	AI_StopProcessInfos (self);
	B_LogEntry (TOPIC_INNOSEYE, "Xardas has agreed to appear for the ritual at the Circle of the Sun.");
	B_GivePlayerXP (XP_Ambient);
	Npc_ExchangeRoutine	(self,"RitualInnosEyeRepair"); 
