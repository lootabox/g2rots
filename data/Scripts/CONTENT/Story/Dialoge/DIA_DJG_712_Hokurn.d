...
FUNC VOID DIA_Hokurn_Hello_ASK1 ()
{
	...
	AI_Output (self ,other,"DIA_Hokurn_Hello_ASK1_01_01"); //Didn't you understand me? PISS OFF!!!
...
FUNC VOID DIA_Hokurn_Hello_ASK2 ()
{
	...
	AI_Output (self ,other,"DIA_Hokurn_Hello_ASK2_01_01"); //You asked for it.
...
{
	AI_Output (self ,other,"B_Hokurn_Sauf_01_00"); //(burps) Ah, that hit the spot.
...
FUNC VOID DIA_Hokurn_Drink_Info()
{
	...
	AI_Output (self ,other,"DIA_Hokurn_Drink_01_01"); //Gimme!
...
FUNC VOID DIA_Hokurn_Question_Info()
{
	...
	AI_Output (self ,other,"DIA_Hokurn_Question_01_01"); //I thought you understood me. I only talk to friends.
