...
func void DIA_BDT_1088_Addon_Torwache_FirstWarn_Info()
{
	...
	&& 		(MIS_Send_Buddler != LOG_SUCCESS)
	{
		...
		{
			AI_Output (self, other,"DIA_Addon_BDT_1088_Addon_Torwache_FirstWarn_06_04"); //Didn't you understand me? GO AWAY!
			Torwache_Greetings = 2;
		}			
		else
		{
			AI_Output (self, other,"DIA_Addon_BDT_1088_Addon_Torwache_FirstWarn_06_05"); //GO AWAY!
		};
	}
	else if (MIS_Send_Buddler == LOG_RUNNING)
	{
