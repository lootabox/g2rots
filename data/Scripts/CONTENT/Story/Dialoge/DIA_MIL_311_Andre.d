...
instance DIA_Andre_Message		(C_INFO)
{
	...
	permanent 	= FALSE; 
	description = "I've got an important message for Lord Hagen.";
};
...
func void DIA_Andre_Message_Dragons()
{
	...
	AI_Output (self, other, "DIA_Andre_Message_Dragons_08_01"); //I KNOW that the armies of the orcs are growing ever stronger.
...
func void DIA_Addon_Andre_MartinEmpfehlung_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Andre_MartinEmpfehlung_08_01"); //What? Show me.
	B_GiveInvItems (other, self, ItWr_Martin_MilizEmpfehlung_Addon,1);
	B_UseFakeScroll();
	AI_Output	(self, other, "DIA_Addon_Andre_MartinEmpfehlung_08_02"); //Well, I'll be...! This must have cost you quite an effort. It's no easy feat to get something like this out of Martin.
...
func void DIA_Andre_Alternative_Info ()
{
	...
	AI_Output (self, other, "DIA_Andre_Alternative_08_01"); //Hmm, you're really serious about this, aren't you?
