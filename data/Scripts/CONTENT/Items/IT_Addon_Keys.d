INSTANCE ITKE_PORTALTEMPELWALKTHROUGH_ADDON (C_Item)
{
	...
	TEXT[2]				=	"Fits the door of the teleporter stone in the portal temple.";
...
INSTANCE ITKE_Greg_ADDON_MIS (C_Item)
{
	...
	TEXT[2]				=	"The key to the captain Greg's hut.";	
	TEXT[5]				= 	NAME_Value;	COUNT[5]	= value;
};
//-----------------------------------------------------------------------
INSTANCE ITKE_Addon_Tavern_01 (C_Item)
{
	...
	TEXT[2]				=	"Fits the tavern in the bandit camp.";
...
INSTANCE ITKE_Addon_Esteban (C_Item)
{
	...
	TEXT[2]				=	"Fits the chest in his hideout.";
...
INSTANCE ITKE_ORLAN_TELEPORTSTATION (C_Item)
{
	...
	TEXT[2]				=	"Fits the door of the cave south of his tavern.";
