...
func void DIA_Bennet_Present_Info ()
{
	...
	if (hero.guild == GIL_DJG)
	{
		...
		AI_Output 	(self ,other,"DIA_Bennet_Present_06_07"); //I have developed a new type of armor. Dragon hunter's armor!
...
instance DIA_Bennet_DJG_ARMOR_M		(C_INFO)
{
	...
	permanent	 = 	TRUE;
	description	 =	"I want to buy the armor."; //Wenn ändern, dann bitte auch in der Info-Instanz. s.u.
};

func int DIA_Bennet_DJG_ARMOR_M_Condition ()
{
	var int AFIP_ShowItem; AFIP_ShowItem = ITAR_DJG_M;
...
{	
	...
	if (B_GiveInvItems (other,self,ItMi_Gold,VALUE_ITAR_DJG_M))
	{
...
{	
	...
	AI_Output 	(self ,other,"DIA_Bennet_BetterArmor_06_01"); //(smiling) Tell me, then.
	...
	AI_Output 	(self ,other,"DIA_Bennet_BetterArmor_06_04"); //My newest armor beats everything you've ever seen. It's lightweight yet sturdy.
...
instance DIA_Bennet_DJG_ARMOR_H		(C_INFO)
{
	...
	permanent	 = 	TRUE;
	description	 =	"Give me the armor."; //Wenn ändern, dann bitte auch in der Info-Instanz. s.u.
};

func int DIA_Bennet_DJG_ARMOR_H_Condition ()
{
	var int AFIP_ShowItem; AFIP_ShowItem = ITAR_DJG_H;
...
{	
	...
	if (B_GiveInvItems (other,self,ItMi_Gold,VALUE_ITAR_DJG_H))
	{
		...
		Npc_RemoveInvItems(self,ItMi_Gold,VALUE_ITAR_DJG_H);
...
func void DIA_Bennet_DRACHENEIER_Info ()
{
	...
	if (DRACHENEIER_angebotenXP_OneTime == FALSE)
	{
	AI_Output			(self, other, "DIA_Bennet_DRACHENEIER_06_04"); //Hmm. Very sturdy material. Ideal for finishing armor. If one can manage to get them open, that is.
	...
	AI_Output			(self, other, "DIA_Bennet_DRACHENEIER_06_08"); //I'll pay you, hmm, let's say 300 gold coins for each egg you can bring me.
...
func void DIA_Bennet_DRACHENEIER_ok ()
{
	...
	AI_Output			(self, other, "DIA_Bennet_DRACHENEIER_ok_06_03"); //(clears throat) You say you took it from lizard people?
...
func void DIA_Bennet_DRACHENEIER_mehr ()
{
	...
	AI_Output			(self, other, "DIA_Bennet_DRACHENEIER_mehr_06_01"); //All right. 350 it is. But I can't give you more than that - or it just won't pay for me.
...
func void DIA_Bennet_StillNeedYou_Info ()
{
	...
	AI_Output	(self, other, "DIA_Bennet_StillNeedYou_06_01"); //Right! It's only me, so who cares. See you later at the dock.
