...
func void DIA_Wolf_BENGAR_Info ()
{
	...
	if ((hero.guild == GIL_SLD) || (hero.guild == GIL_DJG))
		{
			AI_Output			(self, other, "DIA_Wolf_BENGAR_08_05"); //Agreed. And since you're one of us, I'll make you a fair price. Just give me 300 gold coins and I'm on my way.
...
func void DIA_Wolf_KnowWhereEnemy_Info ()
{
	...
	if (crewmember_count >= Max_Crew)
	{
		...
		AI_Output			(self, other, "DIA_Wolf_KnowWhereEnemy_08_03"); //So THAT'S the way it is. First you wave a red flag at me and then nothing comes of it, eh?
