...
FUNC VOID DIA_Ramirez_Hallo_Info()
{
	...
	&& (Join_Thiefs == FALSE) 
	{
		...
		AI_Output (self, other, "DIA_Ramirez_Hallo_14_01");//If anything happens to you here, no one's going to help you. So be careful. (grins)
	};
	if  (Join_Thiefs == TRUE)
	{
...
{	
	...
	else 
	{
		...
		Info_ClearChoices (DIA_Ramirez_Bezahlen);
		Info_AddChoice (DIA_Ramirez_Bezahlen,"Maybe later...",DIA_Ramirez_Bezahlen_Spaeter);
