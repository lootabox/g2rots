...
func void DIA_Addon_Quarhodron_Hello_Info ()
{
	...
	|| (PLAYER_TALENT_FOREIGNLANGUAGE[LANGUAGE_3] == TRUE)
	{
		...
		AI_Output	(self, other, "DIA_Addon_Quarhodron_Hello_11_01"); //Tell me, what do you desire?
	...
	else
	{
		...
		else 
		{
			if (Quarhodrons_NextQuestion == 1)
			{
				...
				{
					AI_Output	(self, other, "DIA_Addon_Quarhodron_Fragen_Choices_11_02"); //(to himself) The abilities of a guardian of the dead would have allowed you to waken me, that is true.
...
func void DIA_Addon_Quarhodron_GibMirKey_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Quarhodron_GibMirKey_11_08"); //My time is done. Alas, I can no longer help you.
	AI_Output	(self, other, "DIA_Addon_Quarhodron_GibMirKey_11_09"); //But remember: beware the chambers of Adanos. Else your death is certain.
	AI_Output	(other, self, "DIA_Addon_Quarhodron_GibMirKey_15_10"); //Wait. What ABOUT the chambers?
	AI_Output	(self, other, "DIA_Addon_Quarhodron_GibMirKey_11_11"); //My strength is failing. Farewell. We shall meet again in the realm of the dead.
	AI_StopProcessInfos (self);
