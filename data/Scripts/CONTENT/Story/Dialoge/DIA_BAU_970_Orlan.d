...
func void DIA_Addon_Orlan_NoMeeting_Info ()
{
	...
	AI_Output (self, other, "DIA_Addon_Orlan_NoMeeting_05_01"); //I see no ring here. Can I get you a drink?
};
...
func void DIA_Orlan_RUESTUNG_Info ()
{
	...
	Info_AddChoice			(DIA_Orlan_RUESTUNG, "I'd like to buy the leather armor." , DIA_Orlan_RUESTUNG_Buy);	
    AFIP_SetChoiceItem(DIA_Orlan_RUESTUNG_Buy, ItAr_Leather_L);
};  
	...
	if (B_GiveInvItems		(other, self, ItMi_Gold, VALUE_ITAR_Leather_L))
		{
			...
			Npc_RemoveInvItems(self,ItMi_Gold,VALUE_ITAR_Leather_L);
...
func void DIA_Orlan_MieteFaellig_Info ()
{
	...
	{
		AI_Output	(self, other, "DIA_Orlan_MieteFaellig_05_00"); //I am delighted with your distinguished visit. Stay as long as you like. It is an honor.
...
func void DIA_Orlan_MieteFaellig_ja ()
{
		...
		if (B_GiveInvItems (other, self, ItMi_Gold,50))
		{
			...
			if (DIA_Orlan_MieteFaellig_OneTime == FALSE)
			{
				...
				AI_Output			(self, other, "DIA_Orlan_MieteFaellig_ja_05_04"); //Hmm. Well, it's none of my business anyway.
