...
func void DIA_Hakon_Paladine_Info ()
{
	...
	AI_Output (self ,other,"DIA_Hakon_Add_12_11"); //In return, I now get to live in the hotel free of charge - ha!
};
...
func void DIA_Hakon_Wieviel_Info ()
{
	...
	if (Npc_KnowsInfo (other, DIA_Hakon_HaradBandits))
	{
		AI_Output (self ,other,"DIA_Hakon_Add_12_25"); //You want to get in Harad's good books, don't you?
...
func void DIA_Hakon_Success_Info ()
{
	...
	AI_Output (self ,other,"DIA_Hakon_Add_12_29"); //No - I don't think that will be necessary. I believe you.
