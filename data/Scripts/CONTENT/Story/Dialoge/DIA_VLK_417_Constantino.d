...
FUNC VOID DIA_Constantino_Heilung_Info()
{
	...
	AI_Output (self, other,"DIA_Constantino_Heilung_10_01"); //Why, are you injured?
...
FUNC VOID DIA_Constantino_LEHRLING_Info()
{
	...
	{
		AI_Output (self, other,"DIA_Constantino_LEHRLING_10_25"); //No way! I have heard rumors that you stand accused as a criminal here in Khorinis!
...
FUNC VOID DIA_Constantino_AlsLehrling_Info()
{
	if (B_GetGreatestPetzCrime (self) > CRIME_NONE)
	{
		AI_Output (self, other,"DIA_Constantino_AlsLehrling_10_00"); //I refuse to instruct you any further as long as you are accused of a crime in town.
...
func void DIA_Constantino_MushroomsRunning_Why()
{
	...
	else if (Constantino_DunkelpilzCounter >= 50)
	{
		...
		AI_Output (other, self,"DIA_Constantino_MushroomsRunning_Why_15_06"); //Oh, man!
	...
	{
		AI_Output (self, other,"DIA_Constantino_MushroomsRunning_Why_10_07"); //You have already asked me that. Who knows, maybe some day I'll actually tell you...
	};
};
