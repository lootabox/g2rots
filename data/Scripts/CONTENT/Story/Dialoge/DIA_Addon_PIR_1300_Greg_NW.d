...
func void DIA_Addon_Greg_NW_Hallo_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Greg_NW_Hallo_01_03"); //Listen. You look like a smart guy to me. I bet you'll go far in life.
...
func void DIA_Addon_Greg_NW_Hallo_weg ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Greg_NW_Hallo_weg_01_01"); //So you won't help me. I'll remember that, pal. We'll meet again.
...
func void DIA_Addon_Greg_NW_Hallo_ja ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Greg_NW_Hallo_ja_01_03"); //Now I'm standing here with no idea how I'm supposed to get into the city.
...
func void DIA_Addon_Greg_NW_Hallo_vorsicht ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Greg_NW_Hallo_vorsicht_01_01"); //Well, I certainly don't move in the same circles as a gentleman like you.
...
func void DIA_Addon_Greg_NW_Stadtwachen_klamotten ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Greg_NW_Stadtwachen_klamotten_01_02"); //Nobody will bother me disguised as a local yokel. Ha ha.
	...
	AI_Output			(other, self, "DIA_Addon_Greg_NW_Stadtwachen_klamotten_15_04"); //What? 50 measly gold coins? You can't be serious.
	AI_Output			(self, other, "DIA_Addon_Greg_NW_Stadtwachen_klamotten_01_05"); //Gold isn't everything, my friend. Take them for now.
...
func void DIA_Addon_Greg_NW_Stadtwachen_nochnicht ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Greg_NW_Stadtwachen_nochnicht_01_01"); //All right. But hurry up about it. I've got no time to lose.
	AI_StopProcessInfos (self);
};
func void DIA_Addon_Greg_NW_Stadtwachen_Schein ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Greg_NW_Stadtwachen_Schein_01_01"); //Oh, I see. I'm supposed to act like I'm a citizen of the town, or what?
	AI_Output			(self, other, "DIA_Addon_Greg_NW_Stadtwachen_Schein_01_02"); //Take a look at me, boy. Nobody is going to believe that.
...
func void DIA_Addon_Greg_NW_Stadtwachen_constantino ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Greg_NW_Stadtwachen_constantino_01_01"); //What? Do I look like I'd be picking flowers in the woods?
...
func void DIA_Addon_Greg_NW_Stadtwachen_geld ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Greg_NW_Stadtwachen_geld_01_01"); //Well, if that worked for me, I'd have tried it already.
...
func void DIA_Addon_Greg_NW_PERM_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Greg_NW_PERM_01_01"); //Listen, kid. I've got important things to do right now.
	AI_Output	(self, other, "DIA_Addon_Greg_NW_PERM_01_02"); //We'll talk again later. Got it?
	AI_StopProcessInfos (self);
};
...
func void DIA_Addon_Greg_NW_MeetGregSecondTime_Info ()
{
	...
	{
		AI_Output	(self, other, "DIA_Addon_Greg_NW_MeetGregSecondTime_01_03"); //I thought you wanted to help me. Instead, you just slipped away.
...
func void DIA_Addon_Greg_NW_was_Info ()
{
	...
	if (MIS_Addon_Greg_BringMeToTheCity != 0)
	{
		...
		AI_Output	(self, other, "DIA_Addon_Greg_NW_was_01_02"); //I'll GIVE you problems, you punk.
	};	
...
func void DIA_Addon_Greg_NW_was_UnNun ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Greg_NW_was_UnNun_01_01"); //Yeah, you big mouth. There is something else.
...
func void DIA_Addon_Greg_NW_was_NoHelp ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Greg_NW_was_NoHelp_01_01"); //Oh. You don't WANT to.
...
func void DIA_Addon_Greg_NW_was_Gold ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Greg_NW_was_Gold_01_03"); //You would crawl under a rock if you knew all I've done.
...
///////////////////////////////////////////////////////////////////////
	...
	{
		AI_Output	(self, other, "DIA_Addon_Greg_NW_RakeCaveThere_01_03"); //What are you waiting for? Go inside and get the stuff.
	};
// --------------------------------------------------------------------
...
func void DIA_Addon_Greg_NW_RakeCavePlundered_No ()
{
	...
	if (RAKEPLACE[Greg_FirstSecret] == TRUE)
	{
		...
		AI_Output			(other, self, "DIA_Addon_Greg_NW_RakeCavePlundered_No_15_02"); //There was nothing THERE.
	};	
...
{                                                                                              
	...
	AI_Output			(self, other, "DIA_Addon_Greg_NW_RakeCavePlundered_gold_01_01"); //Give it here.
...
func void DIA_Addon_Greg_NW_DexterFound_wo ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Greg_NW_DexterFound_wo_01_01"); //Really? TELL ME!
	...
	AI_Output			(self, other, "DIA_Addon_Greg_NW_DexterFound_wo_01_04"); //Hah! Yep. That's him.
...
{
	AI_Output	(self, other, "DIA_Addon_Greg_NW_CaughtDexter_01_00"); //Where is that swine?
...
{
	AI_Output	(self, other, "DIA_Addon_Greg_NW_WodennNu_01_00"); //Now where did he go?
	AI_Output	(other, self, "DIA_Addon_Greg_NW_WodennNu_15_01"); //He was here.
	AI_Output	(self, other, "DIA_Addon_Greg_NW_WodennNu_01_02"); //Well, go and find him then!
	AI_StopProcessInfos (self);
};
...
func void DIA_Addon_Greg_NW_RavensLetter_Info ()
{
	...
	&& (Saturas_NW.aivar[AIV_TalkedToPlayer] == TRUE)
	{
		...
		AI_Output	(self, other, "DIA_Addon_Greg_NW_RavensLetter_01_06"); //What's this nonsense?
		AI_Output	(self, other, "DIA_Addon_Greg_NW_RavensLetter_01_07"); //Bah. Water Mages. Can't you come up with something better?
	};
	
	AI_Output	(other, self, "DIA_Addon_Greg_NW_RavensLetter_15_08"); //No.
	AI_Output	(self, other, "DIA_Addon_Greg_NW_RavensLetter_01_09"); //So I'm stranded here...
