...
func void DIA_Addon_Saturas_Nefarius_Info ()
{
	...
	&& (Npc_HasItems (other,ItWr_Map_NewWorld_Ornaments_Addon))
	{
		...
		//B_UseFakeScroll ();
		B_UseFakeMap();
		AI_Output (self, other, "DIA_ADDON_Saturas_Nefarius_14_06"); //Hmm. It is very dangerous in the big forest. You should not go alone.
...
func void DIA_Addon_Saturas_Hallo_weißtdu ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Saturas_Hallo_weißtdu_14_04"); //Mind your tongue!
	AI_Output			(self, other, "DIA_Addon_Saturas_Hallo_weißtdu_14_05"); //What the blazes do you want here anyway?
...
func void DIA_Addon_Saturas_Hallo_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Saturas_Hallo_14_02"); //But say, don't I know you? Of course. You bastard...
	AI_Output	(self, other, "DIA_Addon_Saturas_Hallo_14_03"); //Don't think that I have forgotten how you betrayed us in the New Camp.
...
func void DIA_Addon_Saturas_Hallo_Video ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Saturas_Video_14_00"); //You drained our mound of ore of all magic power and then simply disappeared!
	AI_Output	(self, other, "DIA_Addon_Saturas_Video_14_01"); //What exactly did you think you were doing?
...
func void DIA_Addon_Saturas_Hallo_notwendig ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Saturas_Hallo_notwendig_14_01"); //What sort of drivel is that? Sleeper? Defeated?
...
func void DIA_Addon_Saturas_Hallo_Spott ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Saturas_Hallo_Spott_14_02"); //That is the limit! Who gave you the right to judge us and our intentions?
...
func void DIA_Addon_Saturas_Lares_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Saturas_Lares_14_01"); //Lares? Really? Where is he?
...
func void DIA_Addon_Saturas_geheimbund_Info ()
{
	...
	if (Lares_Angekommen == TRUE)
	{
		AI_Output	(self, other, "DIA_Addon_Saturas_geheimbund_14_01"); //WHAT? How do you know about that? Who..? LARES... I will kill him!
	...
	AI_Output	(self, other, "DIA_Addon_Saturas_geheimbund_14_03"); //I don't know what I should say. I only trust you where I can keep an eye on you.
	AI_Output	(other, self, "DIA_Addon_Saturas_geheimbund_15_04"); //It was Vatras who told me about the Ring.
	AI_Output	(self, other, "DIA_Addon_Saturas_geheimbund_14_05"); //What? Vatras? Wonderful! Of all the Water Mages on the island, you run into the one who DOESN'T know you.
	AI_Output	(self, other, "DIA_Addon_Saturas_geheimbund_14_06"); //I'm warning you, don't do anything stupid this time.
	AI_Output	(other, self, "DIA_Addon_Saturas_geheimbund_15_07"); //I'll make an effort...
...
func void DIA_Addon_Saturas_wasmachstdu_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Saturas_wasmachstdu_14_01"); //These halls conceal ancient secrets. Mysterious secrets.
...
func void DIA_Addon_Saturas_WhatsOrnament_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Saturas_WhatsOrnament_14_01"); //It is the key to a portal.
...
func void DIA_Addon_Saturas_ScRanger_Info ()
{
	...
	if 	(
		...
		)
		{
			...
			AI_Output	(self, other, "DIA_Addon_Saturas_ScRanger_14_04"); //Very well. I shall accept your entrance into our ranks.
...
func void DIA_Addon_Saturas_OpenPortal_Info ()
{
	...
	{
		AI_Output	(self, other, "DIA_Addon_Saturas_OpenPortal_14_01"); //Good! As a new member of our children, you should be granted this honor.
		...
		{	
			...
			{
				AI_Output	(self, other, "DIA_Addon_Saturas_OpenPortal_14_04"); //I see. Of course you couldn't restrain yourself and you absolutely had to open it, yes?
				AI_Output	(other, self, "DIA_Addon_Saturas_OpenPortal_15_05"); //Well, uhh...
				AI_Output	(self, other, "DIA_Addon_Saturas_OpenPortal_14_06"); //I hope for your sake that my still very delicate trust in you will not be shaken.
			}
			else
			{
				AI_Output	(self, other, "DIA_Addon_Saturas_OpenPortal_14_07"); //Very interesting. All right.
