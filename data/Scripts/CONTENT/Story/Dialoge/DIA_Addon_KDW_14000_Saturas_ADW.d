...
func void DIA_Addon_Saturas_ADWStart_Info ()
{
	...
	AI_Output	(other, self, "DIA_Addon_Saturas_ADWStart_15_01"); //What? How are you already HERE?
	...
	AI_Output	(other, self, "DIA_Addon_Saturas_ADWStart_15_04"); //SEVERAL DAYS? How can that be?
...
func void DIA_Addon_Saturas_ADWStart_RavenAim ()
{
	...
	AI_Output (self, other, "DIA_Addon_Bodo_14_02"); //We can certainly assume that he is not up to anything good...
};
...
func void DIA_Addon_Saturas_ADWStart_equipment ()
{
	...
	if (Npc_HasEquippedArmor(other) == FALSE) {
		AI_Output (self, other, "DIA_Addon_Saturas_CUSTOM_14_02"); //And don't run around in those rags!
	};
};
func void DIA_Addon_Saturas_ADWStart_wastun2 ()
{
	...
	AI_Output			(other, self, "DIA_Addon_Saturas_ADWStart_wastun2_15_08"); //Is that all? I can do that left-handed.
	AI_Output			(self, other, "DIA_Addon_Saturas_ADWStart_wastun2_14_09"); //I know that it is much to ask. Regard it as a chance to regain my trust.
		...
		if ((Npc_HasItems (other,ItMi_Addon_Stone_01)) && (Saturas_SCFound_ItMi_Addon_Stone_01 == FALSE))
			{
				...
				AI_Output	(self, other, "DIA_Addon_Saturas_Tokens_14_07"); //The tablets bear the sign of Quarhodron, a great warrior.
				...
				AI_Output	(self, other, "DIA_Addon_Saturas_Tokens_14_09"); //Tsk. I bet the bandits don't even know what it is they are trading there.
		...
		if ((Npc_HasItems (other,ItMi_Addon_Stone_02)) && (Saturas_SCFound_ItMi_Addon_Stone_02 == FALSE))
			{
				...
				Log_AddEntry (TOPIC_Addon_Relicts,"A purple stone tablet found in a building to the south. It was related to the guardians of the dead."); 
			};	
		...
		if ((Npc_HasItems (other,ItMi_Addon_Stone_03)) && (Saturas_SCFound_ItMi_Addon_Stone_03 == FALSE))
			{
				...
				Log_AddEntry (TOPIC_Addon_Relicts,"A blue stone tablet found in a structure to the southwest. It had something to do with the priests of the city."); 
			};		 
		if ((Npc_HasItems (other,ItMi_Addon_Stone_04)) && (Saturas_SCFound_ItMi_Addon_Stone_04 == FALSE))
			{
				...
				Log_AddEntry (TOPIC_Addon_Relicts,"A green stone tablet found in a building near the great swamp. It appears to have been the house of the healers."); 
			};		 
		if ((Npc_HasItems (other,ItMi_Addon_Stone_05)) && (Saturas_SCFound_ItMi_Addon_Stone_05 == FALSE))
			{
				...
				Log_AddEntry (TOPIC_Addon_Relicts,"A yellow stone tablet found in a large structure in a ravine. It must have been the library of the scholars."); 
		};		 
...
func void DIA_Addon_Saturas_AdanosZorn_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Saturas_AdanosZorn_14_03"); //Rhademes, the son of the commander Quarhodron, desecrated the temple.
...
func void DIA_Addon_Saturas_RavenInfos_Info ()
{
	...
	&& (DIA_Addon_Saturas_RavenInfos_OneTime4 == FALSE)
	{
		...
		AI_Output	(self, other, "DIA_Addon_Saturas_RavenInfos_14_18"); //What?! That is a CATASTROPHE! Why didn't you follow him?!
...
func void DIA_Addon_Saturas_TuerZu_Info ()
{
	...
	AI_Output (self, other, "DIA_Addon_Saturas_TuerZu_14_02"); //I must think...
	...
	AI_Output (self, other, "DIA_Addon_Saturas_TuerZu_14_11"); //A ritual...
	AI_Output (self, other, "DIA_Addon_Saturas_TuerZu_14_12"); //Yes! That's it!
...
func void DIA_Addon_Saturas_GhostQuestions_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Saturas_GhostQuestions_14_05"); //Hmm... we know that the scholars of this city built a library to the north.
...
func void DIA_Addon_Saturas_TalkedToGhost_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Saturas_TalkedToGhost_14_06"); //By Adanos. What fools we are. How could we be so innocent.
	AI_Output	(self, other, "DIA_Addon_Saturas_TalkedToGhost_14_07"); //The hints in the records...
	AI_Output	(self, other, "DIA_Addon_Saturas_TalkedToGhost_14_08"); //This sword can only be the 'Claw of Beliar'.
