...
func void DIA_Addon_Vatras_Cavalorn_Bandit ()
{
	...
	AI_Output (self, other, "DIA_Addon_Vatras_Cavalorn_Bandit_05_01"); //By Adanos. That's not good. That's not good at all.
...
func void DIA_Addon_Vatras_Cavalorn_Cavalorn ()
{
	...
	AI_Output (self, other, "DIA_Addon_Vatras_Cavalorn_Cavalorn_05_01"); //Cavalorn?! Where is he?
...
func void DIA_Addon_Vatras_CavalornSentMe_Info ()
{
	...
	AI_Output (self, other, "DIA_Addon_Vatras_Add_05_03"); //(smiling) Aha... So you want to JOIN us, son?
};
...
func void DIA_Addon_Vatras_TellMe_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Vatras_TellMe_05_01"); //And why would I do that?
		Vatras_Why = TRUE;
	}
	else
	{
...
{
	AI_Output (other, self, "DIA_Addon_Vatras_TellMe_Konkret_15_00"); //And what does that mean in concrete terms?
...
FUNC VOID DIA_Vatras_INFLUENCE_FIRST_TRUTH()
{
	...
	{
		AI_Output (self, other, "DIA_Vatras_INFLUENCE_FIRST_TRUTH_05_02"); //Dragons? You speak of beings which, until now, have only been mentioned in legends. How do you know this?
	};
	Info_ClearChoices   (DIA_Addon_Vatras_WannaBeRanger);
...
FUNC VOID DIA_Vatras_INFLUENCE_FIRST_LIE()
{
	...
	if (Vatras_First == 2)
	{
		AI_Output (self, other, "DIA_Vatras_INFLUENCE_FIRST_LIE_05_01"); //Aha. And who has told you this?
	}
	else 
 	{
...
FUNC VOID DIA_Vatras_INFLUENCE_SECOND_TRUTH()
{
	...
	{
		AI_Output (self, other, "DIA_Vatras_INFLUENCE_SECOND_TRUTH_05_02"); //The necromancer... So he lives... and he sent you? Who are you really?
	};
	Info_ClearChoices   (DIA_Addon_Vatras_WannaBeRanger);
...
FUNC VOID DIA_Vatras_INFLUENCE_SECOND_LIE()
{
	...
	if (Vatras_Second == 2)
	{
		AI_Output (self, other, "DIA_Vatras_INFLUENCE_SECOND_LIE_05_01"); //Do you at least remember where you come from?
	}
	else
	{
...
func void DIA_Addon_Vatras_HowToJoin_Sleeper ()
{
	...
	AI_Output (self, other, "DIA_Addon_Vatras_HowToJoin_Sleeper_05_02"); //Including the story about the banning of the beast called the Sleeper.
...
func void DIA_Addon_Vatras_Free_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Vatras_Free_05_03"); //Adanos, bless this man. Light his path and grant him the strength to withstand all dangers.
...
func void DIA_Addon_Vatras_Waffen_Success ()
{
	...
	if (Fernando_ImKnast == TRUE)
	{
		...
		&& (SC_IsRanger == FALSE)
		{
			AI_Output (other, self, "DIA_Addon_Vatras_Waffen_Success_15_05"); //Does that mean that you're going to let me join the 'Ring of Water' now?
			AI_Output (self, other, "DIA_Addon_Vatras_Waffen_Success_05_06"); //THAT was not what we agreed upon - (smiling) and you know it.
		};
...
func void DIA_Vatras_HEAL_Info ()
{
	...
	{
		AI_Output			(self, other, "DIA_Vatras_HEAL_05_01"); //Adanos bless this body. Free it of its wounds and strengthen it with new life.
...
func VOID DIA_Vatras_MISSION_YES()
{
    ...
    AFIP_SetChoiceItem(DIA_Vatras_MISSION_LIGHT, ItSc_Light);
	Info_AddChoice 		(DIA_Vatras_MISSION,"I choose the healing spell.",DIA_Vatras_MISSION_HEAL);	
    AFIP_SetChoiceItem(DIA_Vatras_MISSION_HEAL, ItSc_LightHeal);
	Info_AddChoice 		(DIA_Vatras_MISSION,"Give me the Ice Arrow.",DIA_Vatras_MISSION_ICE);	
    AFIP_SetChoiceItem(DIA_Vatras_MISSION_ICE, ItSc_Icebolt);
};
...
func void DIA_Vatras_MESSAGE_SUCCESS_Info ()
{
    ...
    AFIP_SetChoiceItem(DIA_Vatras_MESSAGE_SUCCESS_Plant, ItPl_Perm_Herb);
	Info_AddChoice 	  (DIA_Vatras_MESSAGE_SUCCESS,"Ring of Skill",DIA_Vatras_MESSAGE_SUCCESS_Ring);	
    AFIP_SetChoiceItem(DIA_Vatras_MESSAGE_SUCCESS_Ring, ItRi_Dex_01);
	Info_AddChoice 	  (DIA_Vatras_MESSAGE_SUCCESS,"1 ore nugget",DIA_Vatras_MESSAGE_SUCCESS_Ore);
    AFIP_SetChoiceItem(DIA_Vatras_MESSAGE_SUCCESS_Ore, ItMI_Nugget);
};
