...
{	
	...
	AI_Output (self ,other,"DIA_Addon_Henry_MeatForMorgan_04_01"); //Aha. And who sent you?
...
func void DIA_Addon_Henry_Malcom_Info ()
{
	...
	AI_Output (self, other, "DIA_Addon_Henry_Malcom_04_01"); //Oh great. I might have known. It's taking forever again.
...
{	
	...
	if (self.aivar[AIV_PASSGATE] == FALSE)
	{
		AI_Output (self ,other,"DIA_Addon_Henry_Palisade_Bandits_04_11"); //Too bad you can't hear it, though. You haven't paid your toll, after all.
		Henry_Zoll_WhatFor = TRUE;
	};
};
...
func void DIA_Addon_Henry_Owen2_Info ()
{
	...
	if ((Npc_IsDead(PIR_1367_Addon_Owen)) == TRUE)
	{
		...
		AI_Output (self, other, "DIA_Addon_Henry_Owen2_04_03"); //High time Morgan finally got around to getting rid of those beasts around here.
...
{	
	...
	if (self.aivar[AIV_PASSGATE] == FALSE)
	{
		...
		AI_Output (self ,other,"DIA_Addon_Henry_WhatTeach_Add_04_02"); //It's all included in the price.
		Henry_Zoll_WhatFor = TRUE;
	}
	else
	{
