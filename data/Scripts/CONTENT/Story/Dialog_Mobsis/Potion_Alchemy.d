...
INSTANCE PC_ItPo_Perm_Mana (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elixir of Spirit (1 Fire Root, 1 King's Sorrel)"; 
};
...
INSTANCE PC_ItPo_Dex (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Potion of Dexterity (1 Goblin Berries, 1 King's Sorrel)"; 
};
...
INSTANCE PC_ItPo_Strg (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Elixir of Strength (1 Dragonroot, 1 King's Sorrel)"; 
};
...
INSTANCE PC_ItPo_Speed (C_INFO)
{
	...
	permanent		= TRUE;
	description		= "Speed Potion (1 Snapperweed, 1 Meadow Knotweed)"; 
};
