...
func void DIA_Sentenza_Hello_HandsOff()
{
	...
	AI_Output (self ,other,"DIA_Sentenza_Hello_HandsOff_09_01"); //Or what?
...
func void DIA_Sentenza_Vzwei_HandsOff()
{
	...
	AI_Output (self ,other,"DIA_Sentenza_Vzwei_HandsOff_09_01"); //So? Apparently you've got a bit more on you this time!
...
{	
	...
	AI_Output (self, other, "DIA_Sentenza_WannaJoin_09_02"); //Do you understand that the mercenaries are going to vote whether you get to join them or not?
};
...
{	
	...
	AI_Output (self, other, "DIA_Sentenza_AufsMaul_09_01"); //(laughs) Okay, that's the way you want it...
