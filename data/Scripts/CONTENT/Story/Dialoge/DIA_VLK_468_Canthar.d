...
{	
	...
	{
		AI_Output (self, other,"DIA_Canthar_PersonalCRIMES_09_01"); //Did you think you could defeat me that easily?
	};
...
{	
	...
	if (Npc_HasEquippedArmor(other) == FALSE) 
	{
		...
		AI_Output	(self, other,"DIA_Canthar_Hallo_09_03"); //Hm! (coughs) You look like a fugitive! All fugitives are headed for the city.
		AI_Output	(self, other,"DIA_Canthar_Hallo_09_04"); //You could even be a former convict from the mining colony.
		AI_Output	(self, other,"DIA_Canthar_Hallo_09_05"); //I don't care where you come from. But I believe I have an interesting offer for you...
...
func void DIA_Canthar_Hallo_NoBauer()
{
	...
	AI_Output	(self, other,"DIA_Canthar_Hallo_NoBauer_09_02"); //If I am not entirely mistaken, I have an interesting offer for you...
...
{	
	...
	if (Canthar_GotME == TRUE)
	{
		...
		{
			AI_Output (self, other,"DIA_Canthar_WhatOffer_09_02"); //If you are as 'convincing' with the guards at the gate as you are with me, they will never let you into the city.
		};
...
func void DIA_Canthar_WhatOffer_Strings()
{
	...
	AI_Output (self, other,"DIA_Canthar_WhatOffer_Strings_09_01"); //No! No catch. You will merely owe me a favor.
};
...
func void DIA_Canthar_WhatOffer_Price()
{
	...
	AI_Output (self, other,"DIA_Canthar_WhatOffer_Price_09_01"); //I KNEW you were the right man!
...
func void DIA_Canthar_Success_Info ()
{
	...
	if (Kapitel == 1)
	{
		...
		CreateInvItems (self, ItMw_ShortSword1 , 1);//ItMw_ShortSword4
		CreateInvItems (self,ItMw_ShortSword5 , 1);
		CreateInvItems (self,ItMw_Kriegshammer1, 1); 
		
		CreateInvItems (self, ItMw_1h_Sld_Sword, 1);//ItMw_1h_Vlk_Sword
		CreateInvItems (self, ItMw_2h_Bau_Axe, 1);//ItMw_1h_Nov_Mace
	};
	if (Kapitel == 2)
	{
