...
FUNC VOID DIA_Onar_WegenSekob_Info()
{
	...
	AI_Output (self, other, "DIA_Onar_WegenSekob_14_06"); //You nitwit! Did you think he just carries that money around? He's hidden it somewhere!
...
FUNC VOID DIA_Onar_CollectGold_Info()
{
	...
	else //genau 1 Tag später...
	{
		...
		{
			AI_Output (self, other, "DIA_Onar_CollectGold_14_13"); //Oh well. Here's your pay.
...
FUNC VOID DIA_Onar_MariaGold_Info()
{
	...
	AI_Output (self, other, "DIA_Onar_MariaGold_14_03"); //That woman has to stick her nose into everything.
