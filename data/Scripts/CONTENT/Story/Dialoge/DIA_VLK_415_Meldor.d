...
func void DIA_Meldor_Lehmar_Info ()
{
	...
	AI_Output (self, other, "DIA_Meldor_Lehmar_07_01"); //(sighs) No. But right across the street here is the house of Lehmar, the moneylender.
...
func void DIA_Meldor_InsOV_Info ()
{
	...
	AI_Output (self, other, "DIA_Meldor_InsOV_07_01"); //Yeah, right. And I was about to board a ship and have it take me to the King for an audience.
...
func void DIA_Meldor_Smoke_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Meldor_Smoke_07_01"); //Nope, no idea.
	}
	else
	{
