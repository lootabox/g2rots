...
FUNC VOID DIA_Addon_Patrick_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Patrick_Hi_07_01");//Really? And why should I believe you?
	...
	AI_Output (self, other, "DIA_Addon_Patrick_Hi_07_05");//All right! I believe you.
	AI_Output (other, self, "DIA_Addon_Patrick_Hi_15_06");//Really? Wow, that went faster than I thought. Okay, now all we need is a plan.
...
FUNC VOID DIA_Addon_Patrick_Hi_Raven()
{
	...
	AI_Output (self, other, "DIA_Addon_Patrick_Hi_Raven_07_01");//(grins) Not a bad idea.
	B_Say_Patrick_Plan();
	Info_ClearChoices (DIA_Addon_Patrick_Hi);
};
FUNC VOID DIA_Addon_Patrick_Hi_Kill()
{
	...
	AI_Output (self, other, "DIA_Addon_Patrick_Hi_Kill_07_01");//But that would be insane!
	B_Say_Patrick_Plan();
	Info_ClearChoices (DIA_Addon_Patrick_Hi);
};
...
FUNC VOID DIA_Addon_Patrick_ready_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Patrick_ready_07_04");//Thanks, thank you so much. We are all very deeply...
