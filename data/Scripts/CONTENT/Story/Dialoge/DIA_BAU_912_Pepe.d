...
func void DIA_Pepe_Hallo_Info ()
{
	...
	AI_Output (self, other, "DIA_Pepe_Hallo_03_01"); //Guarding sheep! (sighs) And if possible, staying out of trouble.
...
func void DIA_Pepe_WhyNotSLD_Info ()
{
	...
	AI_Output (self, other, "DIA_Pepe_WhyNotSLD_03_04"); //I'm already regretting that, too.
};
...
func void DIA_Pepe_KillWolves_Info ()
{
	...
	AI_Output (self, other, "DIA_Pepe_KillWolves_03_01"); //You, by yourself? Ha ha. I don't believe it. I'd sooner trust my bellwether to do that.
	...
	AI_Output (self, other, "DIA_Pepe_KillWolves_03_03"); //Wait a minute. Okay, okay! Ehm... you're the greatest and you can take on a hundred wolves at once. No problem!
	AI_Output (self, other, "DIA_Pepe_KillWolves_03_04"); //Mostly they lurk between the trees near the pasture. I think there were only four...
...
func void DIA_Pepe_KilledWolves_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Pepe_KilledWolves_03_01"); //You did it! Thank Innos!
