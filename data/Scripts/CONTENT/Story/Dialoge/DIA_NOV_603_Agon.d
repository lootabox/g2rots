...
{
	AI_Output (self ,other,"DIA_Agon_Hello_07_00"); //What do you want?
};
...
FUNC VOID DIA_Agon_YouAndBabo_Info()
{
	...
	AI_Output	(self ,other,"DIA_Agon_YouAndBabo_07_02"); //Let's get something straight: I shall go my own way. The way that Innos foreordained for me.
...
FUNC VOID DIA_Agon_YouAndBabo_AllTogether ()
{
	...
	AI_Output (self ,other,"DIA_Agon_YouAndBabo_AllTogether_07_02"); //But please, don't waste my time. And no one should get in my way.
...
{
	AI_Output (self ,other,"DIA_Agon_GolemDead_07_00"); //You are too late!
...
{
	AI_Output (other,self ,"DIA_Agon_GolemDead_NoWay_15_00"); //Only if you get out of here alive.
...
FUNC VOID DIA_Agon_GolemDead_ShutUp ()
{
	...
	AI_Output (self ,other,"DIA_Agon_GolemDead_ShutUp_07_01"); //It is hopeless, you have lost! Resign yourself to it.
...
FUNC VOID DIA_Agon_GolemDead_ShutUp_MyChest ()
{
	...
	AI_Output (self ,other,"DIA_Agon_GolemDead_ShutUp_MyChest_07_01"); //No, you cannot do that, I will kill you first.
...
FUNC VOID DIA_Agon_GolemDead_ShutUp_YouWin ()
{
	...
	AI_Output (self ,other,"DIA_Agon_GolemDead_ShutUp_YouWin_07_01"); //No, you cannot deceive me. You're trying to get rid of me.
...
FUNC VOID DIA_Agon_GolemDead_Congrat ()
{
	...
	AI_Output (self ,other,"DIA_Agon_GolemDead_Congrat_07_01"); //What does that mean? What are you planning?
	AI_Output (other,self ,"DIA_Agon_GolemDead_Congrat_15_02"); //What are you talking about?
	AI_Output (self ,other,"DIA_Agon_GolemDead_Congrat_07_03"); //You want to dispute my victory. You want to kill me and take all the glory for yourself!
...
{
	AI_Output (self ,other,"DIA_Agon_GolemLives_07_00"); //You found the hiding place before me. That cannot be...
	AI_Output (self ,other,"DIA_Agon_GolemLives_07_01"); //That must not be! I shall not permit it.
...
FUNC VOID DIA_Agon_Perm_Info()
{
	...
	{
		AI_Output	(self ,other,"DIA_Agon_Perm_07_02"); //You are only a guest here in the monastery of Innos. Therefore you should act accordingly and not disturb me while I am working. Good day.
	};
	AI_StopProcessInfos(self);
};
