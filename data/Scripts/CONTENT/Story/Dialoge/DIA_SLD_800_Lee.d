...
FUNC VOID DIA_Lee_PETZMASTER_Info()
{
	...
	{
		AI_Output (self, other, "DIA_Lee_PETZMASTER_04_00"); //Who the devil let YOU in here - YOU are the new fellow who has been causing trouble?
...
{
	AI_Output (self, other, "DIA_Lee_Hallo_04_00"); //Who the devil let YOU in here... (gasps) What are you doing here? I thought you were dead!
...
FUNC VOID DIA_Lee_Paladine_Info()
{
	...
	AI_Output (self, other, "DIA_Lee_Paladine_04_01"); //What's your business with the paladins?
...
FUNC VOID DIA_Lee_Background_Info()
{
	...
	AI_Output (other, self, "DIA_Lee_Add_15_16"); //On the King?!
	AI_Output (self ,other, "DIA_Lee_Add_04_17"); //On the King! And on all his sycophants. They will all bitterly regret what they did to me...
};
...
func void DIA_Lee_AboutGorn_Who()
{
	...
	AI_Output (self, other, "DIA_Lee_AboutGorn_Who_04_01"); //Big, dark, bad, with a big axe - he recaptured our ore mine with you back in the colony.
};
...
{	
	...
	if (other.guild == GIL_SLD)
	{
		...
		AI_Output (self ,other, "DIA_Lee_Add_04_23"); //And if not... Then we'll find another way to get out of here...
	}
	else
	{
...
instance DIA_Lee_BuyArmorM (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Give me the armor.";
};                       
FUNC INT DIA_Lee_BuyArmorM_Condition()
{
	var int AFIP_ShowItem; AFIP_ShowItem = ItAr_Sld_M;
...
{	
	...
	if (B_GiveInvItems (other, self, itmi_gold, VALUE_ITAR_SLD_M))
	{
		...
		Npc_RemoveInvItems(self,ItMi_Gold,VALUE_ITAR_SLD_M);
...
instance DIA_Lee_BuyArmorH (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Give me the heavy armor.";
};                       
FUNC INT DIA_Lee_BuyArmorH_Condition()
{
	var int AFIP_ShowItem; AFIP_ShowItem = ItAr_Sld_H;
...
{	
	...
	if (B_GiveInvItems (other, self, ItMi_Gold, VALUE_ITAR_SLD_H))
	{
		...
		Npc_RemoveInvItems(self,ItMi_Gold,VALUE_ITAR_SLD_H);
...
func void DIA_Lee_SYLVIO_Info ()
{
	...
	AI_Output			(self, other, "DIA_Lee_SYLVIO_04_05"); //Ah. Basically, I'm glad that Sylvio is finally gone from the farm.
};
