...
FUNC VOID DIA_Marduk_Kap3_Hello_NotYourConcern ()
{
	...
	if (hero.guild == GIL_PAL)
	{
		AI_Output (self ,other,"DIA_Marduk_Kap3_Hello_NotYourConcern_05_01"); //A paladin should always be polite and modest. It is your task to protect those who cannot protect themselves.
		AI_Output (self ,other,"DIA_Marduk_Kap3_Hello_NotYourConcern_05_02"); //It is a privilege and you should be thankful that Innos offers you this opportunity. Think about that!
	};
	if (hero.guild == GIL_DJG)
	{
		AI_Output (self ,other,"DIA_Marduk_Kap3_Hello_NotYourConcern_05_03"); //There were times when it was not possible for rabble to enter our holy monastery. You are proof that those were better times.
		AI_Output (self ,other,"DIA_Marduk_Kap3_Hello_NotYourConcern_05_04"); //I warn you, don't get up to anything here or you will be immediately punished. We shall exercise no false lenience.
	};	
	Info_ClearChoices (DIA_Marduk_Kap3_Hello);
};
...
FUNC VOID DIA_Marduk_Kap3_PERM_Info()
{
	...
	AI_Output (self ,other,"DIA_Marduk_Kap3_PERM_05_04"); //The enemy has apparently already entered the city.
	...
	AI_Output (self ,other,"DIA_Marduk_Kap3_PERM_05_07"); //In broad daylight! It has gone too far, but I fear that is only the beginning.
