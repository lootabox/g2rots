...
FUNC VOID DIA_Pal_213_Schiffswache_IAmKDF_Info()
{
	...
	AI_Output (self ,other,"DIA_Pal_213_Schiffswache_IAmKDF_01_01"); //No, of course not. May Innos forgive me.
	AI_Output (self ,other,"DIA_Pal_213_Schiffswache_IAmKDF_01_02"); //The Magicians of Fire are the guardians of the wisdom of Innos...
	AI_Output (self ,other,"DIA_Pal_213_Schiffswache_IAmKDF_01_03"); //... whoever doubts them, doubts Innos and forfeits any right to mercy.
};
...
FUNC VOID DIA_Pal_213_Schiffswache_IAmKDF2_Info()
{
	...
	AI_Output (self ,other,"DIA_Pal_213_Schiffswache_IAmKDF2_01_01"); //I shall kill... I mean, stop you.
};
...
FUNC VOID DIA_Pal_213_Schiffswache_IAmKDF3_Info()
{
	...
	AI_Output (self ,other,"DIA_Pal_213_Schiffswache_IAmKDF3_01_01"); //I would never lay a hand on a magician.
	AI_Output (other,self ,"DIA_Pal_213_Schiffswache_IAmKDF3_15_02"); //So what would you do if I went aboard?
	AI_Output (self ,other,"DIA_Pal_213_Schiffswache_IAmKDF3_01_03"); //Nothing, Sir.
};
...
FUNC VOID DIA_Pal_213_Schiffswache_IAmKDF4_Info()
{
	...
	AI_Output (self ,other,"DIA_Pal_213_Schiffswache_IAmKDF4_01_01"); //You mustn't do that, Lord Hagen's orders were quite clear.
};
...
FUNC VOID DIA_Pal_213_Schiffswache_IAmKDF6_Info()
{
	...
	AI_Output (self ,other,"DIA_Pal_213_Schiffswache_IAmKDF6_01_01"); //Understood. You may go on board.
