...
{	
	...
	if (self.aivar[AIV_PARTYMEMBER] == TRUE)
	{
		...
		{
			AI_Output (self ,other,"DIA_Addon_Matt_Alright_10_01"); //Everything's ship-shape, Cap'n! (smirks)
		};
	}
...
{	
	...
	AI_Output (self ,other,"DIA_Addon_Matt_FollowMe_10_03"); //Ah, I see! That's different of course. I mean, of course I'm coming.
...
func VOID DIA_Addon_Matt_Anheuern_ShutUp()
{
	...
	AI_Output (self ,other,"DIA_Addon_Matt_FollowMe_ShutUp_10_01"); //Aye aye, Cap'n! (smirks)
...
func void DIA_Addon_Matt_ComeOn_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Matt_ComeOn_10_01"); //Aye aye, Cap'n!
		AI_StopProcessInfos (self);
...
{	
	...
	AI_Output (self, other, "DIA_Addon_Matt_GoHome_10_01"); //(to himself) I need a decent swig of grog!
...
{	
	AI_Output (self, other, "DIA_Addon_Matt_TooFar_10_01"); //You can go it alone from here, Cap'n. (smirks)
...
{	
	AI_Output (self, other, "DIA_Addon_Matt_Healing_10_01"); //(smirks) Hello Cap'n! I could use a healing potion!
};
