...
func void DIA_Addon_Martin_Farim_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Martin_Farim_07_05"); //Fish! As if I didn't have enough crap to deal with.
...
func void DIA_Addon_Martin_Rangerhelp_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Martin_Rangerhelp_07_06"); //Okay. Then pay attention.
	...
	AI_Output	(self, other, "DIA_Addon_Martin_Rangerhelp_07_09"); //Strangely enough, the paladins never see anything.
	AI_Output	(self, other, "DIA_Addon_Martin_Rangerhelp_07_10"); //I'm going crazy. I can't spend the entire night standing around here like an idiot.
...
func void DIA_Addon_Martin_Auftrag_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Martin_Auftrag_07_01"); //Sweet.
...
func void DIA_Addon_Martin_FromVatras_Info ()
{
	...
	AI_Output (self, other, "DIA_Addon_Martin_FromVatras_07_05"); //Ah, is that so...
};	
///////////////////////////////////////////////////////////////////////
//	Tell Me
///////////////////////////////////////////////////////////////////////
...
func void DIA_Addon_Martin_Perm_Info ()
{
	...
	&&	(MIS_Addon_Martin_GetRangar == LOG_RUNNING)
	{
		AI_Output	(self, other, "DIA_Addon_Martin_Perm_07_01"); //You bastard, you were supposed to guard my crates. Now something else is missing.

		if (Wld_IsTime (24,00,03,00))
		{
			AI_Output	(self, other, "DIA_Addon_Martin_Perm_07_02"); //Go straight to the provisions store at the harbor and grab me the scumbag who stole from me, got it?
		}
		else
		{
