...
{
	AI_Output	(self, other, "DIA_Addon_Skip_NW_Hallo_08_00"); //There you are at last. I've been waiting here for hours.
	AI_Output	(self, other, "DIA_Addon_Skip_NW_Hallo_08_01"); //Just a moment. You're not a merchant from town, are you?
	AI_Output	(self, other, "DIA_Addon_Skip_NW_Hallo_08_02"); //Where is Baltram?
};
...
func void DIA_Addon_Skip_NW_WerBistDu_Info ()
{
	...
	AI_Output	(other, self, "DIA_Addon_Skip_NW_WerBistDu_15_02"); //Who?
	...
	AI_Output	(self, other, "DIA_Addon_Skip_NW_WerBistDu_08_05"); //Come on, you must have heard of me.
...
func void DIA_Addon_Skip_NW_WerBistDu_ja ()
{
	...
	AI_Output (self, other, "DIA_Addon_Skip_NW_WerBistDu_ja_08_01"); //Honestly? You've really heard of me before?
...
func void DIA_Addon_Skip_NW_WerBistDu_pirat ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Skip_NW_WerBistDu_pirat_08_01"); //Yes, damnit. That's plain to see. And a cross one at that.
...
func void DIA_Addon_Skip_NW_MissingPeople_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Skip_NW_MissingPeople_08_01"); //Er... damnit, it's not what you think it is.
...
func void DIA_Addon_Skip_NW_Name_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Skip_NW_Name_08_02"); //Hmm. I just can't recall his name. Even if it wasn't all that complicated.
