...
func void DIA_Addon_Myxir_ADWHello_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Myxir_ADWHello_12_03"); //Even their mighty rituals and summonings could not save them.
...
func void DIA_Addon_Myxir_GeistTafel_Info ()
{
	...
	AI_Output (self, other, "DIA_Addon_Myxir_GeistTafel_12_03"); //By Adanaos!
	...
	AI_Output (self, other, "DIA_Addon_Myxir_GeistTafel_12_08"); //The grave of the warrior prince Quarhodron is supposed to lie in the west of the valley.
	AI_Output (self, other, "DIA_Addon_Myxir_GeistTafel_12_09"); //You will have to find it... and waken Quarhodron.
...
func void DIA_Addon_Myxir_GeistTafel_wie ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Myxir_GeistTafel_wie_12_01"); //Find Quarhodron's grave in the west of the valley.
...
func void DIA_Addon_Myxir_TalkedToGhost_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Myxir_TalkedToGhost_12_01"); //Then you were really able to waken him from the realm of the dead?
