...
FUNC VOID DIA_Addon_Fisk_Attentat_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Fisk_Attentat_12_01"); //I have my own worries, I'm a victim myself.
	...
	AI_Output (self, other, "DIA_Addon_Fisk_Attentat_12_05"); //I've been robbed - probably by some of our own people!
};
...
FUNC VOID DIA_Addon_Fisk_Lieferung_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Fisk_Lieferung_12_02"); //But a guy named Juan snatched it away from me. Including the gold that I paid for it!
...
//---------------------------------------------------------------------
	func void B_Addon_Fisk_Belohnung()
	{
		...
		AI_Output (self, other, "DIA_Addon_Fisk_Belohnung_12_06"); //One hand washes the other - that hasn't changed since back then.
	};
//---------------------------------------------------------------------
...
FUNC VOID DIA_Addon_Fisk_GivePaket_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Fisk_GivePaket_12_01"); //Indeed! What about Juan?
...
FUNC VOID DIA_Addon_Fisk_GivePicks_Info()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Fisk_GivePicks_12_02"); //That isn't a dozen! You're not trying to cheat me, are you?
	};
};
...
FUNC VOID DIA_Addon_Fisk_Inspektor_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Fisk_Inspektor_12_01"); //What?
	AI_Output (other, self, "DIA_Addon_Fisk_Inspektor_15_02"); //Don't play games with me! You knew about it!
	AI_Output (self, other, "DIA_Addon_Fisk_Inspektor_12_03"); //Fine. You're right. But I hope you also realize why I didn't tell you about it.
