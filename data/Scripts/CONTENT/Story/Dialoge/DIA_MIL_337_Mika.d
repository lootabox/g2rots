...
func void DIA_Mika_UEBERLEGT_Info ()
{
	...
	if (B_GiveInvItems (other, self, ItMi_Gold,10))
		...
		{
			AI_Output			(self, other, "DIA_Mika_UEBERLEGT_12_02"); //Come back when you have the money.
			AI_StopProcessInfos (self);	
		};
};
...
func void DIA_Mika_HILFE_Akil ()
{
	...
	AI_Output			(self, other, "DIA_Mika_HILFE_Akil_12_01"); //What? Those riff-raff are hanging around on Akil's farm? Then let's not waste any time. Follow me.
