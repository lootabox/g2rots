...
func void DIA_Wulfgar_Hallo_Info ()
{
	...
	AI_Output (self, other, "DIA_Wulfgar_Hallo_04_01"); //These boys swing their swords like farmers.
	AI_Output (self, other, "DIA_Wulfgar_Hallo_04_02"); //But when I'm done with them, every single one of them will be a tough, hard bastard.
};
...
func void DIA_Wulfgar_Bonus_Info ()
{
	...
	PrintScreen (ConcatStrings (PRINT_Learn1H, " + 2"), -1, -1, FONT_Screen, 2);
};
