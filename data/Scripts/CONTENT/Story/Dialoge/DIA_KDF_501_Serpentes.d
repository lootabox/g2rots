...
{
	AI_Output (self, other, "DIA_Serpentes_NOTALK_10_00"); //You dare to address me, novice? Return to your work.
...
FUNC VOID DIA_Serpentes_NOTALK_QUESTION()
{
	...
	AI_Output (self, other, "DIA_Serpentes_NOTALK_QUESTION_10_01"); //You do not seem to want to understand. I decide when I see fit to talk to you. Who do you think you are?
...
func void DIA_Serpentes_YOURSTORY_Info ()
{
	...
	AI_Output (self, other, "DIA_Serpentes_YOURSTORY_10_01"); //In all humility, I can tell you this. Everyone else who has attempted this is dead.
	AI_Output (self, other, "DIA_Serpentes_YOURSTORY_10_02"); //You really should not attempt to take this test. Your spirit is weak. Better to serve in the monastery and perhaps you will be chosen in a few years.
...
func void DIA_Serpentes_NOIDEA_Info ()
{
	...
	AI_Output (self, other, "DIA_Serpentes_NOIDEA_10_01"); //I have told you everything. Or do you find this test too difficult?
...
{
	AI_Output (self, other, "DIA_Serpentes_NOHELP_10_00"); //Go and carry out your task, novice!
	AI_StopProcessInfos (self);
};
///////////////////////////////////////////////////////////////////////
//	Info SUCCESS
...
func void DIA_Serpentes_SUCCESS_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Serpentes_SUCCESS_10_02"); //But now you have betrayed yourself! It was you who killed Garwig!
	...
	{
		AI_Output (self, other, "DIA_Serpentes_SUCCESS_10_04"); //Nevertheless, I must admit that you have fulfilled the task I have given you.
	};
...
func void DIA_Serpentes_MinenAnteile_nein ()
{
	...
	AI_Output			(self, other, "DIA_Serpentes_MinenAnteile_nein_10_01"); //That is outrageous! You will never reach the upper circles of magic if you are not willing to do the Brotherhood a service.
