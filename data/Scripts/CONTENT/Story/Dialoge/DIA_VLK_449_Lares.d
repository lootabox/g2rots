...
func void DIA_Addon_Lares_Vatras_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Lares_Vatras_09_01"); //So you've already been to see Vatras. You must have made a lasting impression on him.
...
func void DIA_Addon_Lares_WannaBeRanger_AboutYou ()
{
	...
	AI_Output (self, other, "DIA_Addon_Lares_WannaBeRanger_AboutYou_09_02"); //(smiling) And they have plenty of reason to be grateful to me.
};
...
func void DIA_Addon_Lares_Ornament_Info ()
{
	...
	AI_Output (self, other, "DIA_Addon_Lares_Ornament_09_01"); //Of course. It's up to me, as usual. I might have known.
...
{
	AI_Output	(other, self, "DIA_Addon_Lares_OrnamentBringJob_15_00"); //I can take the ornament there for you!
	AI_Output	(self, other, "DIA_Addon_Lares_OrnamentBringJob_09_01"); //Hmm. I think I had better take it there myself. But you could come with me.
...
func void DIA_Addon_Lares_BaltramAbloese_Info ()
{
	...
	if (SC_IsRanger == FALSE)
	{
		...
		{
			AI_Output (self, other, "DIA_Addon_Lares_BaltramAbloese_09_03"); //(smiling) I assume it will come in handy for you, until you get your own.
		}
		else
		{
			AI_Output (self, other, "DIA_Addon_Lares_BaltramAbloese_09_04"); //(smiling) Who knows, you might want to join us...
		};
	};
...
func void DIA_Addon_Lares_PeopleMissing_Success()
{
	...
	AI_Output	(self, other, "DIA_Addon_Lares_PeopleMissing_Success_09_01"); //Really?
...
func void DIA_Addon_Lares_RangerHelp_ruestung ()
{
	...
	AI_Output (self, other, "DIA_Addon_Lares_RangerHelp_ruestung_09_01"); //Hmm. Matteo sells armor. But he'll probably charge you an arm and a leg for it.
...
func void DIA_Addon_Lares_Gilde_MIL ()
{
	...
	AI_Output (self, other, "DIA_Addon_Lares_Gilde_MIL_09_01"); //(laughs) Yes. I can imagine you'd like that, eh? Read the law to other people while you're pocketing their purses.
...
{	
	...
	AI_Output (self, other, "DIA_Lares_AboutSld_09_03"); //(laughs) If you're squeamish, you don't have a chance of joining them...
};	
...
func void DIA_Lares_OtherGuild_Info ()
{
	...
	|| (other.guild == GIL_PAL)
	{
		...
		AI_Output (self, other, "DIA_Lares_OtherGuild_09_03"); //Only you could pull something like that...
	
		if (Lares_WorkForLee == TRUE)
		{
			AI_Output (self, other, "DIA_Lares_OtherGuild_09_04"); //You won't blow the whistle on me about working for Lee, will you?
...
func void DIA_Addon_Lares_ArrivedPortalInterWeiter_Info ()
{
	...
	&& ((Npc_IsDead(Erol))==FALSE)
	{
		...
		AI_Output	(self, other, "DIA_Addon_Lares_ArrivedPortalInterWeiter_09_02"); //Too bad for him, but we don't have time for that now.
	};
...
{
	AI_Output (self, other, "DIA_Addon_Lares_Albern_09_00"); //Stop goofing off! Take that ornament to Saturas already!
	AI_StopProcessInfos (self);
};
...
func void DIA_Addon_Lares_PortalInterWEITER_Info ()
{
	...
	{
		AI_Output	(other, self, "DIA_Addon_Lares_PortalInterWEITER_15_01"); //Yeah, yeah.
	};
...
func void DIA_Lares_TEACH_BACK()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Lares_TEACH_BACK_Add_09_00"); //Good. Your strength has increased.
	};
