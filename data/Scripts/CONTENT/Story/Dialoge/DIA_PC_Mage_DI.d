...
{	
	...
	AI_Output (self ,other,"DIA_Milten_DI_Rat_03_01"); //Hmm. It is a great honor that you should ask me, of all people, for advice. Only one thing has been on my mind the whole time.
...
func void DIA_Milten_DI_Rat_nein ()
{
	...
	AI_Output			(self, other, "DIA_Milten_DI_Rat_nein_03_01"); //You are so... What will you do then if you encounter dragons here on the island?
...
func void DIA_Milten_DI_PEDROTOT_Info ()
{
	...
	AI_Output			(self, other, "DIA_Milten_DI_PEDROTOT_03_01"); //What? Where? Here on the island? Damn, but he is absolutely unbelievable.
			...
			if (hero.guild == GIL_KDF)
				{
					...
					AI_Output (other,self ,"DIA_Milten_DI_UndeadDragonDead_15_09"); //Hmm. Maybe.
				};		
