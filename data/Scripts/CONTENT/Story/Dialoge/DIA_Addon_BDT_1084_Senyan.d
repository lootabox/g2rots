...
{
	AI_Output (self, other, "DIA_Addon_Senyan_Attack_12_00");//Then what do I still need you for, you bum?
	AI_Output (self, other, "DIA_Addon_Senyan_Attack_12_01");//Hey, people, look who we have here!
...
FUNC VOID B_Senyan_Erpressung()
{
	...
	AI_Output (self, other, "DIA_Addon_Senyan_Erpressung_12_01");//Oh, no, please. I don't want to extort gold from you. I wouldn't dream of it.
...
FUNC VOID DIA_Addon_Senyan_Attentat_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Senyan_Attentat_12_06");//And when you have found him - I want you to kill him for me.
...
FUNC VOID DIA_Addon_Senyan_Attentat_JA()
{
	...
	AI_Output (self, other, "DIA_Addon_Senyan_Attentat_JA_12_02");//When you find out who the guy is - we'll kill the tick together. And now beat it!
...
{	
	AI_Output (self, other, "DIA_Addon_BDT_1084_Senyan_derbe_12_00");//You haven't kept our agreement.
