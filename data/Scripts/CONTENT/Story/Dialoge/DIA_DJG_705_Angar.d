...
func void DIA_AngarDJG_HALLO_Info ()
{
	...
	AI_Output			(self, other, "DIA_AngarDJG_HALLO_04_01"); //Call me Angar. I have set aside my title. The Brotherhood of the Sleeper has disbanded.
	...
	AI_Output			(self, other, "DIA_AngarDJG_HALLO_04_04"); //Oh, I haven't been able to sleep properly for some time. These constant nightmares.
...
{
	AI_Output			(self, other, "DIA_AngarDJG_UndeadMageDead_04_00"); //Only death and destruction! I must get out of here!
	AI_StopProcessInfos (self);
...
{
	AI_Output			(self, other, "DIA_AngarDJG_UNDEADMAGECOMES_04_00"); //There it is! Do you hear that?
