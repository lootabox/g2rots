...
CONST STRING TXT_TALENTS_SKILLS	[NPC_TALENT_MAX] =
{
	...
	" |1|2|3|4|5|6",											//NPC_TALENT_MAGE				= 7;	// Magiekreis
...
const string NAME_Dot_Fire				= "Half of damage is dealt as fire damage. ";
...
const string NAME_Fear_Info				= "Unharmed targets flee during effect. ";
...
const string NAME_IceStorm_Info			= "May hit multiple times. ";
...
const string NAME_PalCombat_Info		= "Mana cost is added to damage.";
const string NAME_PalRepelEvil_Info		= "Unharmed targets flee during effect. Only affects evil.";
...
const string NAME_Bonus_MageStaff_Blades_2H_03	= "Shock duration and damage is doubled.";
const string NAME_Bonus_MageStaff_Good_2H_01	= "";
const string NAME_Bonus_MageStaff_Good_2H_02	= "All living targets are vulnerable to ice spells.";
const string NAME_Bonus_MageStaff_Good_2H_03	= "Fire spells deal all damage as fire damage.";
...
const string NAME_Bonus_MageStaff_Normal_2H_03	= "Summon duration is doubled.";
...
const string NAME_ADDON_MALUS_2H					= "Two-handed talent - penalty:";
const string NAME_ADDON_MALUS_1H					= "One-handed talent - penalty:";
...
// ------ G_CanNotUse ------
const string PRINT_HITPOINTS_MISSING		= "more Hitpoint(s) required.";
const string PRINT_HITPOINTS_MAX_MISSING	= "more maximum Hitpoint(s) required.";
const string PRINT_MANA_MISSING				= "more Mana point(s) required.";
const string PRINT_MANA_MAX_MISSING			= "more maximum Mana point(s) required.";
const string PRINT_STRENGTH_MISSING			= "more Strength point(s) required.";
const string PRINT_DEXTERITY_MISSING		= "more Dexterity point(s) required.";
