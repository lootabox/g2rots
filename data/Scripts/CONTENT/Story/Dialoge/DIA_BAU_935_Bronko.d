...
{
	AI_Output			(self, other, "DIA_Bronko_HALLO_06_00"); //So, where are we headed, then?
...
func void DIA_Bronko_HALLO_hiergeld ()
{
	...
	if ((Npc_HasItems (other,ItMi_Gold)) >= 5)
	{
		...
		AI_Output			(self, other, "DIA_Bronko_HALLO_hiergeld_06_01"); //Thank you. And have a nice day.
		AI_StopProcessInfos (self);	 
	}
	else
	{
...
func void DIA_Bronko_FLEISSIG2_Info()
{
	...
	{
		AI_Output(self,other,"Dia_Bronko_FLEISSIG_06_03");	//You won't go fetch those mercenaries, huh?
	}
	else
	{
		AI_Output(self,other,"Dia_Bronko_FLEISSIG_06_04");	//Don't beat me, please.
