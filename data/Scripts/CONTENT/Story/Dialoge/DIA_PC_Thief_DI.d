...
{	
	...
	&& (EVT_DIBRIDGE_OPENED == FALSE)
	{
		...
		AI_Output (self ,other,"DIA_PC_Thief_DI_RAT_11_05"); //Hmm. Have you already tried a ranged weapon? Maybe the mechanism could be activated with a shot.
	}
...
{	
	...
	if ((Npc_GetDistToWP(self,"WP_UNDEAD_MIDDLE_01")<4000) )
	{
		...
		AI_Output (self ,other,"DIA_PC_Thief_DI_UndeadDragonDead_11_02"); //How on earth did you manage to get past that thing?
	...
	if (DIA_PC_Thief_DI_UndeadDragonDead_OneTime == FALSE )
	{
		...
		AI_Output (self ,other,"DIA_PC_Thief_DI_UndeadDragonDead_11_09"); //Hmm. Or maybe I'll simply take over Bromor's business. There's always money in that. Honest money.
