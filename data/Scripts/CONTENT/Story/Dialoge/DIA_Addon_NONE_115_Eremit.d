...
func void DIA_Addon_Eremit_Hello_Info ()
{
	...
	AI_Output (self, other, "DIA_Addon_Eremit_Add_04_05"); //And other PEOPLE - thank Innos - never show up here... Until today.
};
...
func void DIA_Addon_Eremit_SeekTafeln_Info ()
{
	...
	AI_Output (self, other, "DIA_Addon_Eremit_Add_04_06"); //Yes... But I'm keeping them!
...
func void DIA_Addon_Eremit_Teach_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Eremit_Add_04_26"); //But you won't get mine! You'll have to find your own!
	};
...
func void DIA_Addon_Eremit_PERM_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Addon_Eremit_Add_04_09"); //I built everything myself. My weapons, my tools, my hut, everything.
