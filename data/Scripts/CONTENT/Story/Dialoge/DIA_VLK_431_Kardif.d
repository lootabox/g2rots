...
FUNC VOID DIA_Kardif_Hallo_Angebot()
{
	...
	AI_Output (self, other, "DIA_Kardif_Hallo_Angebot_14_01"); //What, 5 gold pieces? Are you trying to ruin me? Let's make it 7.
...
FUNC VOID DIA_Kardif_Hallo_Ablehnen()
{
	...
	AI_Output (self, other, "DIA_Kardif_Hallo_Ablehnen_14_01"); //Hey, wait... Alright, 5 gold pieces. But that's my final offer!
...
func void DIA_Kardif_Lernen_Info ()
{
	if B_GiveInvItems (other,self,ItMi_Gold, Kardif_Deal)
	{
		...
		AI_Output (self, other, "DIA_Kardif_Lernen_14_08"); //HE is easy to find. His hut is right next to my pub. (to himself) I should have charged double for that one.
...
FUNC VOID DIA_Kardif_Zeichen_Info()
{
	...
	AI_Output (self, other, "DIA_Kardif_Zeichen_14_01");//If you ever need some lock picks, come to me. I still have a few around. Just ask me for something to drink.
