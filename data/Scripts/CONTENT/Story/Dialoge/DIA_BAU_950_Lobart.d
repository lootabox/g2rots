...
func void DIA_Lobart_STOLENCLOTHS_HereYouGo ()
{
	...
	AI_Output (self, other, "DIA_Lobart_STOLENCLOTHS_HereYouGo_05_02"); //Now go make yourself useful!
...
func void DIA_Lobart_STOLENCLOTHS_DontHaveIt ()
{
	...
	AI_Output (self, other, "DIA_Lobart_STOLENCLOTHS_DontHaveIt_05_01"); //You already sold them, huh? I'll teach you, buddy!
...
func void DIA_Lobart_STOLENCLOTHS_ForgetIt ()
{
	...
	AI_Output (self, other, "DIA_Lobart_STOLENCLOTHS_ForgetIt_05_01"); //I'll teach you, buddy!
...
func void DIA_Lobart_Hallo_Info ()
{
	if (hero.guild == GIL_NONE)
	{
		...
		AI_Output (self, other, "DIA_Lobart_Hallo_05_01"); //Whose side are you on? The rebelling farmers or the King?
...
func void DIA_Lobart_Hallo_ForTheKing()
{
	...
	AI_Output (self, other, "DIA_Lobart_Hallo_ForTheKing_05_01"); //'For the King!' That's what the city guard said when they took half my sheep.
...
func void DIA_Lobart_BuyClothes_Info ()
{
	...
	Info_AddChoice		(DIA_Lobart_BuyClothes, ConcatStrings(ConcatStrings("Give me the work clothes, then. (", IntToString(Wert_LobartsRuestung)), " gold)"), DIA_Lobart_BuyClothes_BUY );
    AFIP_SetChoiceItem(DIA_Lobart_BuyClothes_BUY, ItAr_BAU_L);
};
...
func void DIA_Lobart_SldInfo_Info ()
{
	...
	AI_Output (self, other, "DIA_Lobart_SldInfo_05_02"); //Everybody knows what you can expect from them...
};
...
func void DIA_Lobart_ORKPROBLEM_Info ()
{
	...
	AI_Output			(self, other, "DIA_Lobart_ORKPROBLEM_05_01"); //Damnit. Doesn't the stress ever end?
