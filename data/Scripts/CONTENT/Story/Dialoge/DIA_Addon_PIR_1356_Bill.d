...
func void DIA_Addon_Bill_Perm2_Info ()
{
	...
	{
		AI_Output	(self, other, "DIA_Addon_Bill_Perm2_03_02"); //Francis got my old job.
...
{	
	...
	AI_Output (self ,other,"DIA_Addon_Bill_FoundFriends_03_03"); //Those damned bandits did this!
	...
	AI_Output (self ,other,"DIA_Addon_Bill_FoundFriends_03_05"); //(to himself) If only I knew the name of the lowlife who did this...
...
{	
	...
	AI_Output (self ,other,"DIA_Addon_Bill_KilledEsteban_03_01"); //And? Did he suffer?
