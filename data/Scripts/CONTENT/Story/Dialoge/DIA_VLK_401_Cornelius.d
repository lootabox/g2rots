...
FUNC VOID DIA_Cornelius_SeeMurder_Info()
{
	...
	AI_Output (self ,other,"DIA_Cornelius_SeeMurder_13_01"); //I need not answer any questions about a current investigation.
...
FUNC VOID DIA_Cornelius_WhatYouSee_Info()
{
	...
	AI_Output (self ,other,"DIA_Cornelius_WhatYouSee_13_01"); //Really, I haven't got any time now.
	AI_Output (self ,other,"DIA_Cornelius_WhatYouSee_13_02"); //You need to go now, the office is closing.
...
FUNC VOID DIA_Cornelius_Enough_Info()
{
	...
	AI_Output (self ,other,"DIA_Cornelius_Enough_13_01"); //I... I saw how the mercenary struck down the paladin from behind.
	AI_Output (self ,other,"DIA_Cornelius_Enough_13_02"); //And then he took his sword and rammed it through his chest.
	AI_Output (other,self ,"DIA_Cornelius_Enough_15_03"); //Are you completely sure?
	AI_Output (self ,other,"DIA_Cornelius_Enough_13_04"); //Yes, of course. I saw it with my own eyes.
	AI_Output (self ,other,"DIA_Cornelius_Enough_13_05"); //But I really haven't got any time now, there's a huge pile of paperwork I need to do.
...
FUNC VOID DIA_Cornelius_DontBelieveYou_Info()
{
	...
	AI_Output (self ,other,"DIA_Cornelius_DontBelieveYou_13_01"); //So what, what are you going to do about it?
...
FUNC VOID DIA_Cornelius_DontBelieveYou_WhatYouWant ()
{
	...
	AI_Output (self ,other,"DIA_Cornelius_DontBelieveYou_WhatYouWant_13_01"); //You don't even have enough gold to pay me.
...
FUNC VOID DIA_Cornelius_DontBelieveYou_WantSurvive ()
{
	...
	AI_Output (self ,other,"DIA_Cornelius_DontBelieveYou_WantSurvive_13_01"); //If you attack me, they'll hang you.
...
FUNC VOID DIA_Cornelius_DontBelieveYou_Monastery()
{
	...
	AI_Output (self ,other,"DIA_Cornelius_DontBelieveYou_Monastery_13_01"); //What do you mean by that?
...
FUNC VOID DIA_Cornelius_DontBelieveYou_KnowYourHome()
{
	...
	AI_Output (self ,other,"DIA_Cornelius_DontBelieveYou_KnowYourHome_13_01"); //What is that supposed to mean?
