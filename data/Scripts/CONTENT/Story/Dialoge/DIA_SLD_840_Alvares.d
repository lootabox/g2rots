...
func void DIA_Alvares_ATTACK_Info ()
{
	...
	Info_AddChoice 	  (DIA_Alvares_ATTACK,"You guys get out of here now, got it?",DIA_Alvares_ATTACK_Witz);	 
...
FUNC VOID DIA_Alvares_ATTACK_Kerle()
{
	...
	AI_Output (self, other, "DIA_Alvares_ATTACK_Kerle_11_02"); //Engardo, let's get started! You grab the farmer - I'm going to take care of this clown!
...
func void DIA_Alvares_Schluss_Info ()
{
	...
	AI_Output (self, other, "DIA_Alvares_Schluss_11_01"); //All right - so I'm going to kill you now. Engardo, let's do them in!
