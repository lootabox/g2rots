...
{	
	if (hero.guild == GIL_PAL)
	{
		AI_Output (self ,other,"DIA_MiltenNW_KAP3_Hello_03_00"); //I can hardly believe it. Are you really a paladin now?
		AI_Output (other,self ,"DIA_MiltenNW_KAP3_Hello_15_01"); //Obviously.
		AI_Output (self ,other,"DIA_MiltenNW_KAP3_Hello_03_02"); //If someone like you is with the paladins, then Beliar's thugs had better watch out.
...
FUNC VOID DIA_MiltenNW_KAP3_Entry_Permit ()
{
	...
	AI_Output (self ,other,"DIA_MiltenNW_KAP3_Entry_Permit_03_02"); //All right. Here's the key to the monastery. Pyrokar is in the church.
