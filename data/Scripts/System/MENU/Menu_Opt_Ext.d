...
INSTANCE MENU_OPT_EXT(C_MENU_DEF)
{
	...
	items[1]		= "MENUITEM_EXT_AMBIENTPFX";
	items[2]		= "MENUITEM_EXT_AMBIENTPFX_CHOICE";

	items[3]		= "MENUITEM_EXT_CLOUDSHADOW";
	items[4]		= "MENUITEM_EXT_CLOUDSHADOW_CHOICE";
	
	items[5]		= "MENUITEM_GRA_ITEMS_EFFECTS";
	items[6]		= "MENUITEM_GRA_ITEMS_EFFECTS_CHOICE";
					
	items[7]		= "MENUITEM_EXT_ENVMAP";
	items[8]		= "MENUITEM_EXT_ENVMAP_CHOICE";
	
	items[9]		= "MENUITEM_EXT_RADIALFOG";
	items[10]		= "MENUITEM_EXT_RADIALFOG_CHOICE";
	
	items[11]		= "MENUITEM_EXT_WATERFADE";
	items[12]		= "MENUITEM_EXT_WATERFADE_CHOICE";

	items[13]		= "MENUITEM_EXT_FFT";
	items[14]		= "MENUITEM_EXT_FFT_CHOICE";

	items[15]		= "MENUITEM_EXT_OBJWIND";
	items[16]		= "MENUITEM_EXT_OBJWIND_CHOICE";

	items[17]		= "MENUITEM_WEAPONTRAILS";
	items[18]		= "MENUITEM_WEAPONTRAILS_CHOICE";

	items[19]		= "MENUITEM_GRA_SKY_EFFECTS";
	items[20]		= "MENUITEM_GRA_SKY_EFFECTS_CHOICE";

	items[21]		= "MENUITEM_GRA_BACK";
...
instance MENUITEM_GRA_ITEMS_EFFECTS(C_MENU_ITEM_DEF)
{
	backpic = MENU_ITEM_BACK_PIC;
	text[0] = "Item effects";
	text[1] = "Toggle magic item effects on/off.";
	posx = 1000;
...
INSTANCE MENUITEM_EXT_ENVMAP(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Reflections";
	text[1]		= 	"Toggle reflective surfaces on/off."; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_EXT_WATERFADE(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Water fading";
	text[1]		= 	"Toggle water distance fading on/off."; // Kommentar
	// Position und Dimension	
...
INSTANCE MENUITEM_EXT_FFT(C_MENU_ITEM_DEF)
{
	backpic		=	MENU_ITEM_BACK_PIC;
	text[0]		=	"Water waves";
	text[1]		= 	"Toggle water wave movement on/off."; // Kommentar
	// Position und Dimension	
...
instance MENUITEM_WEAPONTRAILS(C_MENU_ITEM_DEF)
{
	...
	text[1] = "Toggle weapon trails on/off, requires restart.";
	posx = 1000;
...
INSTANCE MENUITEM_GRA_SKY_EFFECTS(C_MENU_ITEM_DEF)
{
	...
	text[1]		= 	"Toggle weather effects on/off."; // Kommentar
	// Position und Dimension	
...
instance MENUITEM_GRA_SKY_EFFECTS_CHOICE(C_MENU_ITEM_DEF)
{
	...
	fontName	=   MENU_FONT_SMALL;
	// Position und Dimension	
	posx		= 5000;		posy		=	MENU_START_Y + MENU_DY*9 + MENU_CHOICE_YPLUS;
	dimx = MENU_CHOICE_DX;	dimy 		= 	MENU_CHOICE_DY;
	// Aktionen
