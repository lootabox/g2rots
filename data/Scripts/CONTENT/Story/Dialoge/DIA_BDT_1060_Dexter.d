...
FUNC VOID DIA_Dexter_Hallo_Info()
{
	...
	if (Bdt13_Dexter_verraten == TRUE) //Gothic2
	{
	...
	else //if (Ranger_SCKnowsDexter == TRUE)//ADDON
	{
		//ADDON>
...
func void DIA_Addon_Dexter_Patrick_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Dexter_Patrick_09_03"); //But I haven't seen him in ages.
	AI_Output	(self, other, "DIA_Addon_Dexter_Patrick_09_04"); //Maybe he got himself hanged at last. I wouldn't know.
...
func void DIA_Addon_Dexter_missingPeople_Raven ()
{
	...
	AI_Output			(self, other, "DIA_Addon_Dexter_missingPeople_Raven_09_02"); //He was a miserable swine even back then, but these days...
	...
	AI_Output			(self, other, "DIA_Addon_Dexter_missingPeople_Raven_09_04"); //His fierce glance will pierce you like the claws of a raptor if you look into his eyes for too long.
	...
	AI_Output			(self, other, "DIA_Addon_Dexter_missingPeople_Raven_09_06"); //There's nothing here for you. Except for certain death.
...
func void DIA_Addon_Dexter_Boss_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Dexter_Boss_09_02"); //I don't see any reason why I should tell you.
};
...
FUNC VOID DIA_Dexter_Vor_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Dexter_Vor_09_02");//It's better for you if you leave now.
...
FUNC VOID DIA_Dexter_Kill_Info()
{
	if (Knows_Dexter == TRUE)
	{
		AI_Output (self, other, "DIA_Addon_Dexter_Add_09_02"); //You asked for this...
	}
	else
	{
...
FUNC VOID DIA_Dexter_Kopf_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Dexter_Add_09_01"); //If that's what you want!
