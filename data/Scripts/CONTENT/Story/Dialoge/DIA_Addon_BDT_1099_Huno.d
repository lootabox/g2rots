...
FUNC VOID DIA_Addon_Huno_Hi_JA()
{
	...
	AI_Output (self, other, "DIA_Addon_Huno_Hi_JA_06_01");//The Old Camp, right! You're that curious guy. I thought you was dead.
...
{	
	...
	AI_Output (self, other, "DIA_Addon_Huno_Blitz_06_02");//Some hid - others fled, and there was a plundering everywhere.
...
{	
	...
	if (Huno_ArmorCheap == FALSE)
	{
		...
		Info_AddChoice (DIA_Addon_Huno_Armor, "Okay, I'll take the armor.", DIA_Addon_Huno_Armor_BUY);
		AFIP_SetChoiceItem(DIA_Addon_Huno_Armor_BUY, ITAR_BDT_H);
	}
	else //CHEAP
	{
		...
		Info_AddChoice (DIA_Addon_Huno_Armor, DIALOG_BACK, DIA_Addon_Huno_Armor_BACK);
		Info_AddChoice (DIA_Addon_Huno_Armor, "Okay, I'll take the armor. (1400 Gold)", DIA_Addon_Huno_Armor_BUY);
		AFIP_SetChoiceItem(DIA_Addon_Huno_Armor_BUY, ITAR_BDT_H);
	};
};
...
func void DIA_Addon_Huno_Armor_Buy()
{
	...
	{	
		...
		Npc_RemoveInvItems(self,ItMi_Gold,BDT_Armor_H_Value);
...
{	
	...
	{
		AI_Output (self, other, "DIA_Addon_Huno_SomeThings_06_02"); //Again? It had better be something important this time...
	};
	...
	if (Finn_TellAll == TRUE) 		
	{
		...
		AI_Output (self, other, "DIA_Addon_Huno_SomeThings_06_04"); //What else?
	...
	if (Paul_TellAll == TRUE)
	{
		...
		AI_Output (self, other, "DIA_Addon_Huno_SomeThings_06_06"); //So? Did he? What else?
		Huno_Counter = Huno_Counter + 1;
	};
	...
	if (Emilio_TellAll == TRUE)
	{
		...
		AI_Output (self, other, "DIA_Addon_Huno_SomeThings_06_08"); //You've been having a chat with old Emilio, eh?
		...
		{
			AI_Output (self, other, "DIA_Addon_Huno_SomeThings_06_11"); //Maybe I should also have a word with him. I'm sure that AFTERWARDS he'll say the exact opposite!
			B_Addon_Huno_Stress();
			AI_StopProcessInfos (self);
		};
	}
...
func void DIA_Addon_Huno_SomeThings_Pro()
{
	...
	AI_Output (self, other, "DIA_Addon_Huno_SomeThings_Pro_06_01"); //You are such an idiot! Do you really think you can toady up to Esteban?
