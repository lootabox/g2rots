...
INSTANCE MFX_PALHOLYBOLT_TRAIL (C_PARTICLEFX)
{
     ppsvalue = 200;
     ppsscalekeys_s = "1";
     ppsislooping = 1;
...
INSTANCE MFX_PALREPELEVIL_INIT (C_PARTICLEFX)
{
     ppsvalue = 5;
     ppsscalekeys_s = "1";
     ppsislooping = 1;
...
INSTANCE MFX_PALREPELEVIL_CAST (C_PARTICLEFX)
{
     ppsvalue = 40;
     ppsscalekeys_s = "1";
     ppsislooping = 1;
...
INSTANCE MFX_PALREPELEVIL_TRAIL (C_PARTICLEFX)
{
     ppsvalue = 20;
     ppsscalekeys_s = "1";
     ppsislooping = 1;
...
INSTANCE MFX_PALREPELEVIL_COLLIDE (C_PARTICLEFX)
{
     ppsvalue = 30;
     ppsscalekeys_s = "1";
     ppsissmooth = 1;
...
INSTANCE MFX_PALDESTROYEVIL_FLASH (C_PARTICLEFX)
{
     ppsvalue = 10;
     ppsscalekeys_s = "1";
     ppsissmooth = 1;
