...
func void DIA_BDT_1013_BANDIT_WHERE_NOTRAP()
{
	...
	Info_ClearChoices 	(DIA_BDT_1013_BANDIT_WHERE);
	Info_AddChoice 		(DIA_BDT_1013_BANDIT_WHERE,"Maybe later...",DIA_BDT_1013_BANDIT_WHERE_LATER);
	Info_AddChoice 		(DIA_BDT_1013_BANDIT_WHERE,"Someone else already tried to trick me...",DIA_BDT_1013_BANDIT_WHERE_DAMALS);
	Info_AddChoice 		(DIA_BDT_1013_BANDIT_WHERE,"Fine! You go first!",DIA_BDT_1013_BANDIT_WHERE_YES);
};
...
func void DIA_BDT_1013_BANDIT_WHERE_PRISONER()
{
	...
	AI_Output (self, other, "DIA_BDT_1013_BANDIT_WHERE_PRISONER_01_01"); //You come from behind the Barrier? Man, then we were there together.
	...
	AI_Output (self, other, "DIA_BDT_1013_BANDIT_WHERE_PRISONER_01_04"); //But what is more important now - you are in big trouble!
...
func void DIA_1013_BANDIT_DEXTER_Info ()
{
	...
	AI_Output (self, other, "DIA_1013_BANDIT_DEXTER_01_03"); //(sighs) Oh man! All right. His name is Dexter. Near the big farm there's a steep rock.
...
func void DIA_1013_BANDIT_PIC_Info ()
{
	...
	AI_Output (self, other, "DIA_1013_BANDIT_PIC_01_01"); //(grins) Sure, after all it's YOUR mug on there.
