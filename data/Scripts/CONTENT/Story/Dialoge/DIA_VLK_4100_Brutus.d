...
func void DIA_Brutus_WARUMNICHTARBBEIT_Info ()
{
	...
	AI_Output			(self, other, "DIA_Brutus_WARUMNICHTARBBEIT_06_01"); //But that's disgusting!
...
func void DIA_Brutus_PERM4_Info ()
{
	...
	{
		AI_Output			(self, other, "DIA_Brutus_PERM4_06_01"); //And you are sure that those meatbugs are gone?
		AI_Output			(other, self, "DIA_Brutus_PERM4_15_02"); //Ahem... look, there's one right behind you.
		AI_Output			(self, other, "DIA_Brutus_PERM4_06_03"); //What?!
...
func void DIA_Brutus_BESSEN_Info ()
{
	...
	AI_Output			(self, other, "DIA_Brutus_BESSEN_06_04"); //NO!
	B_NpcClearObsessionByDMT (self);
