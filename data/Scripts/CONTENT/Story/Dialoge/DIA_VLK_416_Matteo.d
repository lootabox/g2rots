...
instance DIA_Matteo_LEATHER		(C_INFO)
{
	...
	permanent	 = 	TRUE;
	description	 = 	"All right, give me the armor.";
};

func int DIA_Matteo_LEATHER_Condition ()
{	
	var int AFIP_ShowItem; AFIP_ShowItem = ItAr_Leather_L;
...
func void DIA_Matteo_LEATHER_Info ()
{
	...
	{
		AI_Output (self, other, "DIA_Matteo_LEATHER_09_02"); //The armor has its price - and it's worth it. So, come back when you got enough gold.
	};
};
...
{	
	...
	AI_Output (self, other, "DIA_Matteo_HelpMeToOV_09_01"); //What?! What are you going to do THERE?
	...
	{
		AI_Output (other, self, "DIA_Matteo_HelpMeToOV_15_04"); //Oh man, forget it!
...
func void B_Matteo_Preis()
{
	...
	AI_Output (self, other, "DIA_Matteo_HelpMeNow_09_02"); //The question is: HOW important is it to you?
...
{	
	...
	AI_Output (self, other, "DIA_Matteo_Minenanteil_09_01"); //Mining shares? Oops. Where did they come from? No idea where I got them. Honestly, your honor.
