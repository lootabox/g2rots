...
{	
	...
	if (randy == 1)
	{
		AI_Output (self,other,"DIA_Addon_Sklaven_3_STANDARD_03_01"); //I didn't do anything! Leave me alone.
	};
	if (randy == 2)
	{
		AI_Output (self,other,"DIA_Addon_Sklaven_3_STANDARD_03_02"); //Please don't hit me!
	};
