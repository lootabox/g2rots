...
FUNC VOID DIA_Addon_Emilio_Attentat_Info()
{
	...
	if (Emilio_Switch == 0)
	{
		AI_Output (self, other, "DIA_Addon_Emilio_Attentat_10_01"); //Hey, man, I didn't have anything to do with it!
		Emilio_Switch = 1;
	}
	else
	{
		AI_Output (self, other, "DIA_Addon_Emilio_Attentat_10_02"); //NOTHING AT ALL!
		Emilio_Switch = 0;
	};
};
...
{	
	...
	{
		AI_Output (self, other, "DIA_Addon_BDT_10015_Emilio_Senyan_10_00");//Tell me, WHY did Senyan yell, 'Look who we have here'?
	...
	AI_Output (self, other, "DIA_Addon_BDT_10015_Emilio_Senyan_10_04");//No, man, I don't have a problem with it.
	AI_Output (self, other, "DIA_Addon_BDT_10015_Emilio_Senyan_10_05");//Quite the opposite. The bastard worked for Esteban.
...
{	
	...
	AI_Output (self, other, "DIA_Addon_Emilio_Jetzt_10_01"); //I was in the mine long enough and slaved away until I was about to fall over. Now I need a few days' rest.
	AI_Output (self, other, "DIA_Addon_Emilio_Jetzt_10_02"); //(sighs) Before I get my next red stone.
};
...
{	
	...
	AI_Output (self, other, "DIA_Addon_Emilio_VonEmilio_10_03"); //I... don't know anything!
...
{	
	...
	AI_Output (self, other, "DIA_Addon_Emilio_HilfMir_10_03"); //I... shit! I'll tell you one name. Nothing more.
