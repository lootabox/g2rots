...
func void DIA_Keroloth_KAP4_HELLO_Info ()
{
	...
	AI_Output			(self, other, "DIA_Keroloth_KAP4_HELLO_07_01"); //Damn it to hell. I tell you, you have to watch like a hawk.
...
func void DIA_Keroloth_KAP4_GELDGEFUNDEN_DJG ()
{
	...
	if (hero.guild == GIL_DJG)
		{
			AI_Output			(self, other, "DIA_Keroloth_KAP4_GELDGEFUNDEN_DJG_07_02"); //They never should have let you into the castle.
		}
		else
		{
