...
func void DIA_Biff_ARBEITEN_Info ()
{
	...
	{
		AI_Output			(self, other, "DIA_Biff_ARBEITEN_07_02"); //Hmm. Why not? What are you paying?
	};
...
func void DIA_Biff_ARBEITEN_HalbeHalbe ()
{
	...
	AI_Output			(self, other, "DIA_Biff_ARBEITEN_HalbeHalbe_07_01"); //That sounds good. But I'm warning you, don't try tricking me, or you'll regret it.
...
{
	if (DJG_Biff_SCGold < Npc_HasItems(hero,ItMi_Gold)-80)
...
func void DIA_Biff_GELDEINTREIBEN_geben ()
{
	...
	Npc_RemoveInvItems (self, ItMi_Gold, BiffsAnteil);
	B_Biff_SetRefuseTalk ();
