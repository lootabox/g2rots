...
FUNC VOID DIA_Addon_Bloodwyn_Wait_FIGHT()
{
	...
	AI_Output (self, other, "DIA_Addon_Bloodwyn_Wait_Raven_FIGHT_04_01");//It's too late for you anyway! Raven is opening the temple right now! (laughs) Die, bastard!
...
{
	AI_Output (self, other, "DIA_Addon_Bloodwyn_Lach_04_00");//(laughs) I'll defeat you all the same!
};
