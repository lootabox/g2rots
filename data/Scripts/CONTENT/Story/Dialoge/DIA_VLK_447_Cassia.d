...
FUNC VOID DIA_Cassia_Vorteil_Info()
{
	...
	AI_Output (self, other, "DIA_Cassia_Vorteil_16_03");//(laughs) No. You only have to stick to our rules. That's all.
};
//////////////////////////////////////////////////////////////////////
...
FUNC VOID DIA_Cassia_Ablehnen_Info()
{
	...
	if (MIS_ThiefGuild_sucked == FALSE)
	{
		...
		AI_Output (self, other, "DIA_Cassia_Ablehnen_16_02");//And don't even think about betraying us. You would bitterly regret that.
...
FUNC VOID DIA_Cassia_Ablehnen_Okay()
{
	...
	AI_Output (self, other, "DIA_Cassia_Ablehnen_Okay_16_01");//(smiling) You've made a wise decision. If you succeed in proving yourself, you may join our ranks.
...
FUNC VOID DIA_Cassia_Aufnahme_Info()
{
	...
	AI_Output (self, other, "DIA_Cassia_Aufnahme_16_02");//Take this key. It opens the door to the hotel. (smiling) Then you won't have to swim every time.
...
FUNC VOID DIA_Cassia_abgeben_Info()
{
	...
	if B_GiveInvItems (other, self, ItMi_BloodCup_MIS,6)
	{
		...
		AI_Output (self, other, "DIA_Cassia_abgeben_16_04");//There's nothing else I have to do for you - but you can learn from me at any time. (smiling) What's more, there's enough on this island just waiting for a taker.
...
FUNC VOID DIA_Cassia_Belohnung_Info()
{
    ...
    AFIP_SetChoiceItem(DIA_Cassia_Belohnung_Gold, ItmI_Gold);
	Info_AddChoice (DIA_Cassia_Belohnung,"Give me the potions. (4 elixirs of healing)",DIA_Cassia_Belohnung_Trank);
    AFIP_SetChoiceItem(DIA_Cassia_Belohnung_Trank, ItPo_Health_03);
	Info_AddChoice (DIA_Cassia_Belohnung, "Give me the ring.",DIA_Cassia_Belohnung_Ring);
    AFIP_SetChoiceItem(DIA_Cassia_Belohnung_Ring, ItRi_Hp_01);
};
