...
FUNC VOID DIA_Babo_Hello_Info()
{
	...
	AI_Output (self ,other,"DIA_Babo_Hello_03_00"); //Hello, you're also new here, aren't you?
...
FUNC VOID DIA_Babo_HowIsIt_Info()
{
	...
	{
		AI_Output (self ,other,"DIA_Babo_HowIsIt_03_01"); //I thank the magicians for my task.
	...
	{
		AI_Output (self ,other,"DIA_Babo_HowIsIt_03_03"); //F.. f.. fine, Master.
...
FUNC VOID DIA_Babo_Kap3_Hello_Info()
{
	...
	if (hero.guild == GIL_KDF)
	{
		AI_Output (self ,other,"DIA_Babo_Kap3_Hello_03_01"); //I try to accomplish the tasks given to me to the satisfaction of the monastery.
	}	
	else
	{
...
FUNC VOID DIA_Babo_Kap3_KeepTheFaith_Info()
{
	...
	AI_Output (self ,other,"DIA_Babo_Kap3_KeepTheFaith_03_01"); //No,... I mean, I would never do such a thing. Honest!
...
FUNC VOID DIA_Babo_Kap3_Unhappy_Info()
{
	...
	AI_Output (self ,other,"DIA_Babo_Kap3_Unhappy_03_01"); //Well... I mean, everything is just fine, really.
	...
	FUNC VOID DIA_Babo_Kap3_Unhappy_Lament ()
	{
		...
		AI_Output (self ,other,"DIA_Babo_Kap3_Unhappy_Lament_03_01"); //I... I... please don't tell the magicians.
	...
	FUNC VOID DIA_Babo_Kap3_Unhappy_TellMe ()
	{
		...
		FUNC VOID DIA_Babo_Kap3_Unhappy_Documents ()
		{
			...
			AI_Output (self ,other,"DIA_Babo_Kap3_Unhappy_Documents_03_01"); //That's nobody's business. It's entirely my affair.
		...
		FUNC VOID DIA_Babo_Kap3_Unhappy_CanHelpYou ()
		{
			...
			AI_Output (self ,other,"DIA_Babo_Kap3_Unhappy_CanHelpYou_03_03"); //Naturally, I'd pay you for that.
			...
			FUNC VOID DIA_Babo_Kap3_Unhappy_Yes ()
			{
				...
				AI_Output (self ,other,"DIA_Babo_Kap3_Unhappy_Yes_03_01"); //Honestly, it just has to work. It has to!
...
FUNC VOID DIA_Babo_Kap3_HaveYourDocs_Info()
{
	...
	AI_Output (self ,other,"DIA_Babo_Kap3_HaveYourDocs_03_03"); //Are they really mine? Are you sure? Show me.
...
FUNC VOID DIA_Babo_Kap3_HaveYourDocs_KeepThem()
{
	...
	AI_Output (self ,other,"DIA_Babo_Kap3_HaveYourDocs_KeepThem_03_01"); //What?! What is that supposed to mean? What are you planning?
	...
	FUNC VOID DIA_Babo_Kap3_HaveYourDocs_KeepThem_JustJoke()
	{
		...
		AI_Output (self ,other,"DIA_Babo_Kap3_HaveYourDocs_KeepThem_JustJoke_03_01"); //Ha ha, I can't laugh about it. So where are they?
	...
	FUNC VOID DIA_Babo_Kap3_HaveYourDocs_KeepThem_Partner()
	{
		...
		AI_Output (self ,other,"DIA_Babo_Kap3_HaveYourDocs_KeepThem_Partner_03_01"); //What?! You can't do that.
...
FUNC VOID DIA_Babo_Kap3_Perm_Info()
{
	...
	if (hero.guild == GIL_KDF)
	{
		AI_Output (self ,other,"DIA_Babo_Kap3_Perm_03_01"); //Yes, of course. My faith in the wisdom and power of Innos gives me strength.
		AI_Output (self ,other,"DIA_Babo_Kap3_Perm_03_02"); //I don't mean to seem disrespectful, but I have a lot to do today.
		AI_Output (other,self ,"DIA_Babo_Kap3_Perm_15_03"); //You may carry on.
		AI_Output (self ,other,"DIA_Babo_Kap3_Perm_03_04"); //Thanks.
	}
	else
	{
