...
func void DIA_BDT_1033_Fluechtling_Tip2_Morgahard ()
{
	...
	AI_Output			(self, other, "DIA_BDT_1033_Fluechtling_Tip2_Morgahard_07_01"); //I don't want any trouble. Go to the landowner. He wanted to hide himself with the mercenaries. And now leave me alone.
	AI_StopProcessInfos (self);
};
...
func void DIA_BDT_1033_Fluechtling_Tip2_Knast ()
{
	...
	AI_Output			(self, other, "DIA_BDT_1033_Fluechtling_Tip2_Knast_07_01"); //NO!
	AI_StopProcessInfos (self);
	B_Attack (self, other, AR_SuddenEnemyInferno , 1);
};
