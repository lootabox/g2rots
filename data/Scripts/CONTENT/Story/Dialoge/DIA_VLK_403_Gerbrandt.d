...
FUNC VOID DIA_Gerbrandt_GreetingsFromDiego_Info()
{
	...
	AI_Output (self ,other,"DIA_Gerbrandt_GreetingsFromDiego_10_01"); //What? Who? What Diego?
	...
	AI_Output (self ,other,"DIA_Gerbrandt_GreetingsFromDiego_10_03"); //That can't be. No! I'm a goner!
	AI_Output (self ,other,"DIA_Gerbrandt_GreetingsFromDiego_10_04"); //Is he in town, then?
	...
	AI_Output (self ,other,"DIA_Gerbrandt_GreetingsFromDiego_10_08"); //(to himself) This is the end, then. All is lost!
