...
INSTANCE MENU_OPTIONS(C_MENU_DEF)
{
	...
	items[2]	= "MENUITEM_OPT_AUDIO";
	items[3]	= "MENUITEM_OPT_VIDEO";
	items[4]	= "MENUITEM_OPT_GRAPHICS";
	items[5]	= "MENUITEM_OPT_EXT";
...
const int MENU_OPT_START_Y	= 1400;
...
INSTANCE MENUITEM_OPT_GAME(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "Gameplay settings.";  // Kommentar
...
INSTANCE MENUITEM_OPT_AUDIO(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "Music, speech and sound effect settings.";  // Kommentar
...
instance MENUITEM_OPT_VIDEO(C_MENU_ITEM_DEF)
{
	...
	text[1]		=	"Graphics card, resolution, color adjustment and video settings.";  // Kommentar
...
INSTANCE MENUITEM_OPT_GRAPHICS(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "View distance, details and user interface settings.";  // Kommentar
...
INSTANCE MENUITEM_OPT_EXT(C_MENU_ITEM_DEF)
{
	...
	text[1]		= "Toggle visual effects on/off.";  // Kommentar
...
INSTANCE MENUITEM_PERF(C_MENU_ITEM_DEF)
{
	...
	// Position und Dimension
	posx		= 0;		posy		= MENU_OPT_START_Y + MENU_OPT_DY*7;
	dimx		= 8192;		dimy		= 800;
	// Aktionen
...
instance MENUITEM_PERF_CHOICE(C_MENU_ITEM_DEF)
{
	...
	// Position und Dimension
	posx		= 4100-2000;		posy		= MENU_OPT_START_Y + MENU_OPT_DY*7+650;
	dimx		= 4000;
	dimy		= 350;
	// Actions
