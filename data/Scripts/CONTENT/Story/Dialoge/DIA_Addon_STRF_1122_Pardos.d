...
FUNC VOID DIA_Addon_Pardos_Hi_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Pardos_Hi_03_01");//I'm beat... completely worn out. Is it a glorious sunny day, or one of those clear nights where a thousand stars are twinkling?
	AI_Output (self, other, "DIA_Addon_Pardos_Hi_03_02");//I don't know... where's the gentle rain of summer... the cool evening breeze... I can feel them no longer...
	AI_Output (self, other, "DIA_Addon_Pardos_Hi_03_03");//It's the eyes that go first in here...
};
//---------------------------------------------------------------------
//	Info save
//---------------------------------------------------------------------
...
FUNC VOID DIA_Addon_Pardos_save_Info()
{
	...
	AI_Output (self, other, "DIA_Addon_Pardos_save_03_01");//Thanks. Thanks for your words.
