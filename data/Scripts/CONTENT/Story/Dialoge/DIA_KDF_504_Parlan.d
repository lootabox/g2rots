...
{
	AI_Output (self, other, "DIA_Parlan_HAMMER_05_00"); //Wait a moment, my son.
...
func void DIA_Parlan_KNOWSJUDGE_Info ()
{
	...
	AI_Output (self, other, "DIA_Parlan_KNOWSJUDGE_05_01"); //What..? Hmm... Are you really serious?
...
{
	AI_Output (self ,other,"DIA_Parlan_DontDisturb_05_00"); //I do not like to repeat my self. Leave the novices alone.
	...
	AI_Output (self ,other,"DIA_Parlan_DontDisturb_05_02"); //I will not tolerate further distractions!
	//Parlan_DontTalkToNovice = LOG_RUNNING;
	AI_StopProcessInfos(self);
};
...
FUNC VOID DIA_Parlan_Kap3U4U5_PERM_Church()
{
	...
	AI_Output (self, other, "DIA_Parlan_Add_05_01"); //Where is the church? Oh my, where could it possibly be?
};
