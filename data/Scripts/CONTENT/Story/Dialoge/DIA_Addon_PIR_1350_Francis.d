...
{	
	...
	AI_Output (self ,other ,"DIA_Addon_Francis_AboutGreg_13_03"); //And he left ME in command!
...
{	
	...
	AI_Output (self, other, "DIA_Addon_Francis_AufsMaul_13_01"); //What? I'm the Captain here!
...
{	
	...
	if (Npc_HasItems (self, ITKE_Greg_ADDON_MIS))
	{
		if (Npc_KnowsInfo (other, DIA_Addon_Francis_LetMeIn))
		{
			AI_Output (self, other, "DIA_Addon_Francis_Buch_13_05"); //You wanted the key to Greg's hut, didn't you?
		};
		...
		AI_Output (self, other, "DIA_Addon_Francis_Buch_13_08"); //But you'll give me the book and keep your trap shut, right?
		B_GiveInvItems (self ,other,ITKE_Greg_ADDON_MIS,1);
	}
	else
	{
	...
	AI_Output (self, other, "DIA_Addon_Francis_Buch_13_13"); //And now give me that thing...
...
{
	return C_StealItem(40, ITKE_Greg_ADDON_MIS);
};
...
{	
	if (!Npc_IsDead(Greg))
	{
		AI_Output (self, other, "DIA_Addon_Francis_Ausgeschissen_13_00"); //Thanks to you, Greg is making me saw planks now until there's no wood left on the island.
	};
