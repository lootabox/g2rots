...
{
	return C_StealItem(30, ItSc_LightningFlash);
};
...
{
	B_StealItem(30, ItSc_LightningFlash);
	Info_ClearChoices(DIA_Addon_Riordian_NW_PICKPOCKET);
};
...
func void DIA_Addon_Riordian_Hallo_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Riordian_Hallo_10_04"); //They built a city on the other side of the mountains... And a temple for Adanos.
};
///////////////////////////////////////////////////////////////////////
//	Info Alter
///////////////////////////////////////////////////////////////////////
...
func void DIA_Addon_Riordian_TeachPre_Info ()
{
	...
	AI_Output	(self, other, "DIA_Addon_Riordian_TeachPre_10_01"); //Ah! A rare artifact. You can use it to train the will-o'-the-wisp, did you know that?
