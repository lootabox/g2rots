...
{
	AI_Output (self, other, "DIA_Igaraz_IMTHEMAN_13_00"); //It has happened. Innos has chosen me and I shall take part in the test of magic.
};
///////////////////////////////////////////////////////////////////////
//	Info METOO
///////////////////////////////////////////////////////////////////////
...
func void DIA_Igaraz_ADD_Info ()
{
	...
	AI_Output (self, other, "DIA_Igaraz_Add_13_01"); //No! Did Serpentes give you this test?
	...
	AI_Output (self, other, "DIA_Igaraz_Add_13_10"); //That's all I'm going to tell you... It's supposed to be your TEST after all!
};
///////////////////////////////////////////////////////////////////////
//	Info Perm Prüfung 
///////////////////////////////////////////////////////////////////////
...
FUNC VOID DIA_Igaraz_TalkAboutBabo_Info()
{
	...
	AI_Output (self ,other,"DIA_Igaranz_TalkAboutBabo_13_01"); //Yes, what's wrong?
};
...
FUNC VOID DIA_Igaraz_BabosBelongings_Info()
{
	...
	AI_Output (self ,other,"DIA_Igaranz_BabosBelongings_13_03"); //He would, wouldn't he. I can imagine. Unfortunately, I prefer to keep them, which brings us to a bit of a dilemma.
};
...
FUNC VOID DIA_Igaraz_WhereDocs_Info()
{
	...
	AI_Output (self ,other,"DIA_Igaranz_WhereDocs_13_01"); //Well, of course I don't have them on me. I'm afraid I can't help you further.
...
FUNC VOID DIA_Igaraz_Price_Info()
{
	...
	AI_Output (self ,other,"DIA_Igaranz_Price_13_01"); //(laughs) Actually they're almost priceless. You very rarely see something like that here.
...
FUNC VOID DIA_Igaraz_Perm_Info()
{
	...
	AI_Output (self ,other,"DIA_Igaranz_Perm_13_01"); //Hmm... no.
